 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $driveService = new CFGS_Google_DriveService(...);
   *   $about = $driveService->about;
   *  </code>
   */
  class CFGS_Google_AboutServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function get($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_About($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_AppsServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function get($appId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_App($data);
      } else {
        return $data;
      }
    }
    ...
    public function listApps($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_AppList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_ChangesServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function get($changeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Change($data);
      } else {
        return $data;
      }
    }
    ...
    public function listChanges($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_ChangeList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_ChildrenServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param string $childId The ID of the child.
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_ChildReference
     */
    public function get($folderId, $childId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_ChildReference($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $folderId The ID of the folder.
     * @param CFGS_Google_ChildReference $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_ChildReference
     */
    public function insert($folderId, CFGS_Google_ChildReference $postBody, $optParams = array()) {
    ...
    public function listChildren($folderId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_ChildList($data);
      } else {
        return $data;
      }
    }
  ...
  class CFGS_Google_CommentsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @return CFGS_Google_Comment
     */
    public function insert($fileId, CFGS_Google_Comment $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_Comment
     */
    public function patch($fileId, $commentId, CFGS_Google_Comment $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_Comment
     */
    public function update($fileId, $commentId, CFGS_Google_Comment $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'commentId' => $commentId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CFGS_Google_FilesServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_DriveFile $postBody
     * @param array $optParams Optional parameters.
     *
     ...
     * @return CFGS_Google_DriveFile
     */
    public function copy($fileId, CFGS_Google_DriveFile $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('copy', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_DriveFile($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_DriveFile
     */
    public function insert(CFGS_Google_DriveFile $postBody, $optParams = array()) {
    ...
    public function listFiles($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_FileList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_DriveFile
     */
    public function patch($fileId, CFGS_Google_DriveFile $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
     ...
     * @return CFGS_Google_DriveFile
     */
    public function update($fileId, CFGS_Google_DriveFile $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class CFGS_Google_ParentsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param string $parentId The ID of the parent.
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_ParentReference
     */
    public function get($fileId, $parentId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_ParentReference($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $fileId The ID of the file.
     * @param CFGS_Google_ParentReference $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_ParentReference
     */
    public function insert($fileId, CFGS_Google_ParentReference $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
    ...
    public function listParents($fileId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_ParentList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_PermissionsServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function get($fileId, $permissionId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Permission($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $fileId The ID for the file.
     * @param CFGS_Google_Permission $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param bool sendNotificationEmails Whether to send notification emails.
     * @return CFGS_Google_Permission
     */
    public function insert($fileId, CFGS_Google_Permission $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
     ...
     * @param string $fileId The ID for the file.
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_PermissionList
     */
    public function listPermissions($fileId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_PermissionList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Permission
     */
    public function patch($fileId, $permissionId, CFGS_Google_Permission $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_Permission
     */
    public function update($fileId, $permissionId, CFGS_Google_Permission $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'permissionId' => $permissionId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class CFGS_Google_RepliesServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @return CFGS_Google_CommentReply
     */
    public function get($fileId, $commentId, $replyId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_CommentReply($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $fileId The ID of the file.
     * @param string $commentId The ID of the comment.
     * @param CFGS_Google_CommentReply $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_CommentReply
     */
    public function insert($fileId, $commentId, CFGS_Google_CommentReply $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'commentId' => $commentId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
     ...
     * @opt_param string pageToken The continuation token, used to page through large result sets. To get the next page of results, set this parameter to the value of "nextPageToken" from the previous response.
     * @return CFGS_Google_CommentReplyList
     */
    public function listReplies($fileId, $commentId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_CommentReplyList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_CommentReply
     */
    public function patch($fileId, $commentId, $replyId, CFGS_Google_CommentReply $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_CommentReply
     */
    public function update($fileId, $commentId, $replyId, CFGS_Google_CommentReply $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'commentId' => $commentId, 'replyId' => $replyId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class CFGS_Google_RevisionsServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function get($fileId, $revisionId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Revision($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $fileId The ID of the file.
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_RevisionList
     */
    public function listRevisions($fileId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_RevisionList($data);
      } else {
        return $data;
      }
    }
     ...
     * @param CFGS_Google_Revision $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Revision
     */
    public function patch($fileId, $revisionId, CFGS_Google_Revision $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_Revision
     */
    public function update($fileId, $revisionId, CFGS_Google_Revision $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'revisionId' => $revisionId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
...
/**
 * Service definition for CFGS_Google_Drive (v2).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_DriveService extends CFGS_Google_Service {
  public $about;
  public $apps;
  public $changes;
  public $children;
...
class CFGS_Google_About extends CFGS_Google_Model {
  ...
  public $rootFolderId;
  public $selfLink;
  protected $__userType = 'CFGS_Google_User';
  protected $__userDataType = '';
  public $user;
  public function setAdditionalRoleInfo(/* array(CFGS_Google_AboutAdditionalRoleInfo) */ $additionalRoleInfo) {
    $this->assertIsArray($additionalRoleInfo, 'CFGS_Google_AboutAdditionalRoleInfo', __METHOD__);
  ...
  public function setExportFormats(/* array(CFGS_Google_AboutExportFormats) */ $exportFormats) {
    $this->assertIsArray($exportFormats, 'CFGS_Google_AboutExportFormats', __METHOD__);
    $this->exportFormats = $exportFormats;
  }
  public function getExportFormats() {
    return $this->exportFormats;
  }
  public function setFeatures(/* array(CFGS_Google_AboutFeatures) */ $features) {
    $this->assertIsArray($features, 'CFGS_Google_AboutFeatures', __METHOD__);
    $this->features = $features;
  }
  public function getFeatures() {
    return $this->features;
  }
  public function setImportFormats(/* array(CFGS_Google_AboutImportFormats) */ $importFormats) {
    $this->assertIsArray($importFormats, 'CFGS_Google_AboutImportFormats', __METHOD__);
  ...
  public function setMaxUploadSizes(/* array(CFGS_Google_AboutMaxUploadSizes) */ $maxUploadSizes) {
    $this->assertIsArray($maxUploadSizes, 'CFGS_Google_AboutMaxUploadSizes', __METHOD__);
  ...
  public function setUser(CFGS_Google_User $user) {
    $this->user = $user;
  }
...
class CFGS_Google_AboutAdditionalRoleInfo extends CFGS_Google_Model {
  protected $__roleSetsType = 'CFGS_Google_AboutAdditionalRoleInfoRoleSets';
  protected $__roleSetsDataType = 'array';
  public $roleSets;
  public $type;
  public function setRoleSets(/* array(CFGS_Google_AboutAdditionalRoleInfoRoleSets) */ $roleSets) {
    $this->assertIsArray($roleSets, 'CFGS_Google_AboutAdditionalRoleInfoRoleSets', __METHOD__);
...
class CFGS_Google_AboutAdditionalRoleInfoRoleSets extends CFGS_Google_Model {
...
class CFGS_Google_AboutExportFormats extends CFGS_Google_Model {
  public $source;
  public $targets;
...
class CFGS_Google_AboutFeatures extends CFGS_Google_Model {
  public $featureName;
  public $featureRate;
...
class CFGS_Google_AboutImportFormats extends CFGS_Google_Model {
  public $source;
  public $targets;
  public function setSource($source) {
    $this->source = $source;
...
class CFGS_Google_AboutMaxUploadSizes extends CFGS_Google_Model {
  public $size;
  public $type;
...
class CFGS_Google_App extends CFGS_Google_Model {
  public $authorized;
  protected $__iconsType = 'CFGS_Google_AppIcons';
  ...
  public function setIcons(/* array(CFGS_Google_AppIcons) */ $icons) {
    $this->assertIsArray($icons, 'CFGS_Google_AppIcons', __METHOD__);
    $this->icons = $icons;
  }
...
class CFGS_Google_AppIcons extends CFGS_Google_Model {
  public $category;
  public $iconUrl;
  public $size;
...
class CFGS_Google_AppList extends CFGS_Google_Model {
  public $etag;
  protected $__itemsType = 'CFGS_Google_App';
  ...
  public function setItems(/* array(CFGS_Google_App) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_App', __METHOD__);
    $this->items = $items;
  }
...
class CFGS_Google_Change extends CFGS_Google_Model {
  public $deleted;
  protected $__fileType = 'CFGS_Google_DriveFile';
  ...
  public function setFile(CFGS_Google_DriveFile $file) {
    $this->file = $file;
  }
...
class CFGS_Google_ChangeList extends CFGS_Google_Model {
  public $etag;
  protected $__itemsType = 'CFGS_Google_Change';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $largestChangeId;
  ...
  public function setItems(/* array(CFGS_Google_Change) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Change', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_ChildList extends CFGS_Google_Model {
  public $etag;
  protected $__itemsType = 'CFGS_Google_ChildReference';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextLink;
  ...
  public function setItems(/* array(CFGS_Google_ChildReference) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_ChildReference', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_ChildReference extends CFGS_Google_Model {
  public $childLink;
  public $id;
  public $kind;
  public $selfLink;
...
class CFGS_Google_Comment extends CFGS_Google_Model {
  public $anchor;
  protected $__authorType = 'CFGS_Google_User';
  protected $__authorDataType = '';
  public $author;
  public $commentId;
  public $content;
  protected $__contextType = 'CFGS_Google_CommentContext';
  ...
  public $kind;
  public $modifiedDate;
  protected $__repliesType = 'CFGS_Google_CommentReply';
  ...
  public function setAuthor(CFGS_Google_User $author) {
    $this->author = $author;
  }
  ...
  public function setContext(CFGS_Google_CommentContext $context) {
  ...
  public function setReplies(/* array(CFGS_Google_CommentReply) */ $replies) {
    $this->assertIsArray($replies, 'CFGS_Google_CommentReply', __METHOD__);
...
class CFGS_Google_CommentContext extends CFGS_Google_Model {
  public $type;
  public $value;
  public function setType($type) {
    $this->type = $type;
...
class CFGS_Google_CommentReply extends CFGS_Google_Model {
  protected $__authorType = 'CFGS_Google_User';
  protected $__authorDataType = '';
  public $author;
  public $content;
...
class CFGS_Google_CommentReplyList extends CFGS_Google_Model {
  protected $__itemsType = 'CFGS_Google_CommentReply';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  public function setItems(/* array(CFGS_Google_CommentReply) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_CommentReply', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_DriveFile extends CFGS_Google_Model {
  ...
  public $iconLink;
  public $id;
  protected $__imageMediaMetadataType = 'CFGS_Google_DriveFileImageMediaMetadata';
  protected $__imageMediaMetadataDataType = '';
  public $imageMediaMetadata;
  protected $__indexableTextType = 'CFGS_Google_DriveFileIndexableText';
  protected $__indexableTextDataType = '';
  public $indexableText;
  public $kind;
  protected $__labelsType = 'CFGS_Google_DriveFileLabels';
  ...
  public $ownerNames;
  protected $__parentsType = 'CFGS_Google_ParentReference';
  protected $__parentsDataType = 'array';
  public $parents;
  public $quotaBytesUsed;
  public $selfLink;
  public $sharedWithMeDate;
  protected $__thumbnailType = 'CFGS_Google_DriveFileThumbnail';
  protected $__thumbnailDataType = '';
  public $thumbnail;
  public $thumbnailLink;
  public $title;
  protected $__userPermissionType = 'CFGS_Google_Permission';
  ...
  public function setImageMediaMetadata(CFGS_Google_DriveFileImageMediaMetadata $imageMediaMetadata) {
    $this->imageMediaMetadata = $imageMediaMetadata;
  }
  public function getImageMediaMetadata() {
    return $this->imageMediaMetadata;
  }
  public function setIndexableText(CFGS_Google_DriveFileIndexableText $indexableText) {
  ...
  public function setLabels(CFGS_Google_DriveFileLabels $labels) {
    $this->labels = $labels;
  }
  ...
  public function setParents(/* array(CFGS_Google_ParentReference) */ $parents) {
    $this->assertIsArray($parents, 'CFGS_Google_ParentReference', __METHOD__);
  ...
  public function setThumbnail(CFGS_Google_DriveFileThumbnail $thumbnail) {
  ...
  public function setUserPermission(CFGS_Google_Permission $userPermission) {
...
class CFGS_Google_DriveFileImageMediaMetadata extends CFGS_Google_Model {
  public $aperture;
  public $cameraMake;
  public $cameraModel;
  public $colorSpace;
  ...
  public $isoSpeed;
  public $lens;
  protected $__locationType = 'CFGS_Google_DriveFileImageMediaMetadataLocation';
  ...
  public function setLocation(CFGS_Google_DriveFileImageMediaMetadataLocation $location) {
...
class CFGS_Google_DriveFileImageMediaMetadataLocation extends CFGS_Google_Model {
  public $altitude;
  public $latitude;
  public $longitude;
...
class CFGS_Google_DriveFileIndexableText extends CFGS_Google_Model {
  public $text;
...
class CFGS_Google_DriveFileLabels extends CFGS_Google_Model {
  public $hidden;
  public $restricted;
  public $starred;
  public $trashed;
...
class CFGS_Google_DriveFileThumbnail extends CFGS_Google_Model {
  public $image;
  public $mimeType;
...
class CFGS_Google_FileList extends CFGS_Google_Model {
  public $etag;
  protected $__itemsType = 'CFGS_Google_DriveFile';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextLink;
  ...
  public function setItems(/* array(CFGS_Google_DriveFile) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_DriveFile', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_ParentList extends CFGS_Google_Model {
  public $etag;
  protected $__itemsType = 'CFGS_Google_ParentReference';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $selfLink;
  ...
  public function setItems(/* array(CFGS_Google_ParentReference) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_ParentReference', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_ParentReference extends CFGS_Google_Model {
  public $id;
  public $isRoot;
  public $kind;
  public $parentLink;
...
class CFGS_Google_Permission extends CFGS_Google_Model {
  public $additionalRoles;
  public $authKey;
  public $etag;
  public $id;
...
class CFGS_Google_PermissionList extends CFGS_Google_Model {
  public $etag;
  protected $__itemsType = 'CFGS_Google_Permission';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $selfLink;
  ...
  public function setItems(/* array(CFGS_Google_Permission) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Permission', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Revision extends CFGS_Google_Model {
  public $downloadUrl;
  public $etag;
  public $exportLinks;
  public $fileSize;
...
class CFGS_Google_RevisionList extends CFGS_Google_Model {
  public $etag;
  protected $__itemsType = 'CFGS_Google_Revision';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $selfLink;
  ...
  public function setItems(/* array(CFGS_Google_Revision) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Revision', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_User extends CFGS_Google_Model {
  ...
  public $kind;
  protected $__pictureType = 'CFGS_Google_UserPicture';
  ...
  public function setPicture(CFGS_Google_UserPicture $picture) {
...
class CFGS_Google_UserPicture extends CFGS_Google_Model {
  public $url;
