 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $ganService = new CFGS_Google_GanService(...);
   *   $advertisers = $ganService->advertisers;
   *  </code>
   */
  class CFGS_Google_AdvertisersServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @return CFGS_Google_Advertisers
     */
    public function listAdvertisers($role, $roleId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_Advertisers($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($role, $roleId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_Advertiser($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_CcOffersServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function listCcOffers($publisher, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_CcOffers($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_LinksServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param string $role The role of the requester. Valid values: 'advertisers' or 'publishers'.
     * @param string $roleId The ID of the requesting advertiser or publisher.
     * @param CFGS_Google_Link $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Link
     */
    public function insert($role, $roleId, CFGS_Google_Link $postBody, $optParams = array()) {
      $params = array('role' => $role, 'roleId' => $roleId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Link($data);
      } else {
        return $data;
      }
    }
    ...
    public function listLinks($role, $roleId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Links($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_PublishersServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function listPublishers($role, $roleId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Publishers($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($role, $roleId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Publisher($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for CFGS_Google_Gan (v1beta1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_GanService extends CFGS_Google_Service {
  public $advertisers;
  public $ccOffers;
  public $events;
  public $links;
...
class CFGS_Google_Advertiser extends CFGS_Google_Model {
  ...
  public function setEpcSevenDayAverage(CFGS_Google_Money $epcSevenDayAverage) {
  ...
  public function setEpcNinetyDayAverage(CFGS_Google_Money $epcNinetyDayAverage) {
  ...
  public function setItem(CFGS_Google_Advertiser $item) {
    $this->item = $item;
  }
...
class CFGS_Google_Advertisers extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Advertiser';
  ...
  public function setItems(/* array(CFGS_Google_Advertiser) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Advertiser', __METHOD__);
    $this->items = $items;
  }
...
class CFGS_Google_CcOffer extends CFGS_Google_Model {
  ...
  public $cardBenefits;
  protected $__rewardsType = 'CFGS_Google_CcOfferRewards';
  ...
  protected $__defaultFeesType = 'CFGS_Google_CcOfferDefaultFees';
  ...
  protected $__bonusRewardsType = 'CFGS_Google_CcOfferBonusRewards';
  ...
  public function setRewards(/* array(CFGS_Google_CcOfferRewards) */ $rewards) {
    $this->assertIsArray($rewards, 'CFGS_Google_CcOfferRewards', __METHOD__);
  ...
  public function setDefaultFees(/* array(CFGS_Google_CcOfferDefaultFees) */ $defaultFees) {
    $this->assertIsArray($defaultFees, 'CFGS_Google_CcOfferDefaultFees', __METHOD__);
  ...
  public function setBonusRewards(/* array(CFGS_Google_CcOfferBonusRewards) */ $bonusRewards) {
    $this->assertIsArray($bonusRewards, 'CFGS_Google_CcOfferBonusRewards', __METHOD__);
...
class CFGS_Google_CcOfferBonusRewards extends CFGS_Google_Model {
  public $amount;
  public $details;
...
class CFGS_Google_CcOfferDefaultFees extends CFGS_Google_Model {
  public $category;
  public $maxRate;
  public $minRate;
  public $rateType;
...
class CFGS_Google_CcOfferRewards extends CFGS_Google_Model {
  public $category;
...
class CFGS_Google_CcOffers extends CFGS_Google_Model {
  protected $__itemsType = 'CFGS_Google_CcOffer';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CFGS_Google_CcOffer) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_CcOffer', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Event extends CFGS_Google_Model {
  protected $__networkFeeType = 'CFGS_Google_Money';
  ...
  public $status;
  public $chargeId;
  protected $__productsType = 'CFGS_Google_EventProducts';
  protected $__productsDataType = 'array';
  public $products;
  protected $__earningsType = 'CFGS_Google_Money';
  protected $__earningsDataType = '';
  public $earnings;
  public $chargeType;
  protected $__publisherFeeType = 'CFGS_Google_Money';
  protected $__publisherFeeDataType = '';
  public $publisherFee;
  protected $__commissionableSalesType = 'CFGS_Google_Money';
  protected $__commissionableSalesDataType = '';
  public $commissionableSales;
  public $publisherId;
  public $eventDate;
  public function setNetworkFee(CFGS_Google_Money $networkFee) {
  ...
  public function setProducts(/* array(CFGS_Google_EventProducts) */ $products) {
    $this->assertIsArray($products, 'CFGS_Google_EventProducts', __METHOD__);
    $this->products = $products;
  }
  public function getProducts() {
    return $this->products;
  }
  public function setEarnings(CFGS_Google_Money $earnings) {
  ...
  public function setPublisherFee(CFGS_Google_Money $publisherFee) {
    $this->publisherFee = $publisherFee;
  }
  public function getPublisherFee() {
    return $this->publisherFee;
  }
  public function setCommissionableSales(CFGS_Google_Money $commissionableSales) {
...
class CFGS_Google_EventProducts extends CFGS_Google_Model {
  protected $__networkFeeType = 'CFGS_Google_Money';
  protected $__networkFeeDataType = '';
  public $networkFee;
  public $sku;
  ...
  protected $__earningsDataType = '';
  public $earnings;
  protected $__unitPriceType = 'CFGS_Google_Money';
  ...
  public function setUnitPrice(CFGS_Google_Money $unitPrice) {
...
class CFGS_Google_Link extends CFGS_Google_Model {
  public $isActive;
  public $linkType;
  public $kind;
  public $endDate;
  public $description;
  public $name;
  protected $__specialOffersType = 'CFGS_Google_LinkSpecialOffers';
  ...
  public function setSpecialOffers(CFGS_Google_LinkSpecialOffers $specialOffers) {
...
class CFGS_Google_LinkSpecialOffers extends CFGS_Google_Model {
  protected $__priceCutType = 'CFGS_Google_Money';
  protected $__priceCutDataType = '';
  public $priceCut;
  protected $__priceCutMinType = 'CFGS_Google_Money';
  protected $__priceCutMinDataType = '';
  public $priceCutMin;
  public $freeShipping;
  public $promotionCodes;
  public $percentOff;
  protected $__percentOffMinType = 'CFGS_Google_Money';
  protected $__percentOffMinDataType = '';
  public $percentOffMin;
  public $freeGift;
  protected $__freeShippingMinType = 'CFGS_Google_Money';
  protected $__freeShippingMinDataType = '';
  public $freeShippingMin;
  public function setPriceCut(CFGS_Google_Money $priceCut) {
    $this->priceCut = $priceCut;
  }
  public function getPriceCut() {
    return $this->priceCut;
  }
  public function setPriceCutMin(CFGS_Google_Money $priceCutMin) {
  ...
  public function setPercentOffMin(CFGS_Google_Money $percentOffMin) {
  ...
  public function setFreeShippingMin(CFGS_Google_Money $freeShippingMin) {
...
class CFGS_Google_Links extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Link';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setNextPageToken($nextPageToken) {
  ...
  public function setItems(/* array(CFGS_Google_Link) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Link', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Money extends CFGS_Google_Model {
  public $amount;
  public $currencyCode;
  public function setAmount($amount) {
    $this->amount = $amount;
...
class CFGS_Google_Publisher extends CFGS_Google_Model {
  public $status;
  public $kind;
  public $name;
  ...
  protected $__epcNinetyDayAverageDataType = '';
  public $epcNinetyDayAverage;
  protected $__itemType = 'CFGS_Google_Publisher';
  protected $__itemDataType = '';
  public $item;
  public $joinDate;
  public $sites;
  ...
  public function setItem(CFGS_Google_Publisher $item) {
    $this->item = $item;
  }
  public function getItem() {
    return $this->item;
...
class CFGS_Google_Publishers extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Publisher';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setNextPageToken($nextPageToken) {
  ...
  public function setItems(/* array(CFGS_Google_Publisher) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Publisher', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
