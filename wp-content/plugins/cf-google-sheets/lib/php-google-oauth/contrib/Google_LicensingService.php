 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $licensingService = new CFGS_Google_LicensingService(...);
   *   $licenseAssignments = $licensingService->licenseAssignments;
   *  </code>
   */
  class CFGS_Google_LicenseAssignmentsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_LicenseAssignmentInsert $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_LicenseAssignment
     */
    public function insert($productId, $skuId, CFGS_Google_LicenseAssignmentInsert $postBody, $optParams = array()) {
      $params = array('productId' => $productId, 'skuId' => $skuId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_LicenseAssignment($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_LicenseAssignmentList
     */
    public function listForProductAndSku($productId, $skuId, $customerId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_LicenseAssignmentList($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $userId email id or unique Id of the user
     * @param CFGS_Google_LicenseAssignment $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_LicenseAssignment
     */
    public function update($productId, $skuId, $userId, CFGS_Google_LicenseAssignment $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_LicenseAssignment
     */
    public function patch($productId, $skuId, $userId, CFGS_Google_LicenseAssignment $postBody, $optParams = array()) {
      $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
...
/**
 * Service definition for CFGS_Google_Licensing (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_LicensingService extends CFGS_Google_Service {
...
class CFGS_Google_LicenseAssignmentInsert extends CFGS_Google_Model {
  public $userId;
  public function setUserId($userId) {
    $this->userId = $userId;
  }
...
class CFGS_Google_LicenseAssignmentList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_LicenseAssignment';
  ...
  public function setItems(/* array(CFGS_Google_LicenseAssignment) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_LicenseAssignment', __METHOD__);
    $this->items = $items;
  }
