 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $predictionService = new CFGS_Google_PredictionService(...);
   *   $trainedmodels = $predictionService->trainedmodels;
   *  </code>
   */
  class CFGS_Google_TrainedmodelsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_Input $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Output
     */
    public function predict($id, CFGS_Google_Input $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('predict', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Output($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param CFGS_Google_Training $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Training
     */
    public function insert(CFGS_Google_Training $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Training($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $id The unique name for the predictive model.
     * @param CFGS_Google_Update $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Training
     */
    public function update($id, CFGS_Google_Update $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CFGS_Google_HostedmodelsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @return CFGS_Google_Output
     */
    public function predict($hostedModelName, CFGS_Google_Input $postBody, $optParams = array()) {
...
/**
 * Service definition for CFGS_Google_Prediction (v1.4).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_PredictionService extends CFGS_Google_Service {
...
class CFGS_Google_InputInput extends CFGS_Google_Model {
  public $csvInstance;
  public function setCsvInstance(/* array(CFGS_Google_object) */ $csvInstance) {
    $this->assertIsArray($csvInstance, 'CFGS_Google_object', __METHOD__);
...
class CFGS_Google_Output extends CFGS_Google_Model {
  public $kind;
  public $outputLabel;
  public $id;
  protected $__outputMultiType = 'CFGS_Google_OutputOutputMulti';
  ...
  public function setOutputMulti(/* array(CFGS_Google_OutputOutputMulti) */ $outputMulti) {
    $this->assertIsArray($outputMulti, 'CFGS_Google_OutputOutputMulti', __METHOD__);
...
class CFGS_Google_OutputOutputMulti extends CFGS_Google_Model {
  public $score;
  public $label;
...
class CFGS_Google_Training extends CFGS_Google_Model {
  public $kind;
  public $storageDataLocation;
  public $storagePMMLModelLocation;
  protected $__dataAnalysisType = 'CFGS_Google_TrainingDataAnalysis';
  protected $__dataAnalysisDataType = '';
  public $dataAnalysis;
  public $trainingStatus;
  protected $__modelInfoType = 'CFGS_Google_TrainingModelInfo';
  ...
  public function setDataAnalysis(CFGS_Google_TrainingDataAnalysis $dataAnalysis) {
  ...
  public function setModelInfo(CFGS_Google_TrainingModelInfo $modelInfo) {
  ...
  public function setUtility(/* array(CFGS_Google_double) */ $utility) {
    $this->assertIsArray($utility, 'CFGS_Google_double', __METHOD__);
...
class CFGS_Google_TrainingDataAnalysis extends CFGS_Google_Model {
  public $warnings;
  public function setWarnings(/* array(CFGS_Google_string) */ $warnings) {
    $this->assertIsArray($warnings, 'CFGS_Google_string', __METHOD__);
...
class CFGS_Google_TrainingModelInfo extends CFGS_Google_Model {
...
class CFGS_Google_Update extends CFGS_Google_Model {
  public $csvInstance;
  public $label;
  public function setCsvInstance(/* array(CFGS_Google_object) */ $csvInstance) {
    $this->assertIsArray($csvInstance, 'CFGS_Google_object', __METHOD__);
