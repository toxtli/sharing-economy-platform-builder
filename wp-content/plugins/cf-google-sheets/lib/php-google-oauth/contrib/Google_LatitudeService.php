 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $latitudeService = new CFGS_Google_LatitudeService(...);
   *   $currentLocation = $latitudeService->currentLocation;
   *  </code>
   */
  class CFGS_Google_CurrentLocationServiceResource extends CFGS_Google_ServiceResource {


    /**
     * Updates or creates the user's current location. (currentLocation.insert)
     *
     * @param CFGS_Google_Location $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Location
     */
    public function insert(CFGS_Google_Location $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Location($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_LocationServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @return CFGS_Google_LocationFeed
     */
    public function listLocation($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_LocationFeed($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for CFGS_Google_Latitude (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_LatitudeService extends CFGS_Google_Service {
...
class CFGS_Google_LocationFeed extends CFGS_Google_Model {
  protected $__itemsType = 'CFGS_Google_Location';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CFGS_Google_Location) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Location', __METHOD__);
    $this->items = $items;
  }
