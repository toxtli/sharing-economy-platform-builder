 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $freebaseService = new CFGS_Google_FreebaseService(...);
   *   $text = $freebaseService->text;
   *  </code>
   */
  class CFGS_Google_TextServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @return CFGS_Google_ContentserviceGet
     */
    public function get($id, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_ContentserviceGet($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for CFGS_Google_Freebase (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_FreebaseService extends CFGS_Google_Service {
  public $text;
  /**
