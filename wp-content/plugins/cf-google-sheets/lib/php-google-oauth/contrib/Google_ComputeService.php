 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $computeService = new CFGS_Google_ComputeService(...);
   *   $operations = $computeService->operations;
   *  </code>
   */
  class CFGS_Google_OperationsServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function get($project, $operation, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_Operation($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_OperationList
     */
    public function listOperations($project, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_OperationList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_KernelsServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function listKernels($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_KernelList($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($project, $kernel, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Kernel($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_DisksServiceResource extends CFGS_Google_ServiceResource {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param CFGS_Google_Disk $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Operation
     */
    public function insert($project, CFGS_Google_Disk $postBody, $optParams = array()) {
    ...
    public function get($project, $disk, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Disk($data);
      } else {
        return $data;
      }
    }
    ...
    public function listDisks($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_DiskList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_SnapshotsServiceResource extends CFGS_Google_ServiceResource {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param CFGS_Google_Snapshot $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Operation
     */
    public function insert($project, CFGS_Google_Snapshot $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
    ...
    public function get($project, $snapshot, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Snapshot($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @return CFGS_Google_SnapshotList
     */
    public function listSnapshots($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_SnapshotList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_ZonesServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function listZones($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_ZoneList($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($project, $zone, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Zone($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_InstancesServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_SerialPortOutput
     */
    public function getSerialPortOutput($project, $instance, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_SerialPortOutput($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($project, $instance, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Instance($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @return CFGS_Google_InstanceList
     */
    public function listInstances($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_InstanceList($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $instance Instance name.
     * @param string $network_interface Network interface name.
     * @param CFGS_Google_AccessConfig $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Operation
     */
    public function addAccessConfig($project, $instance, $network_interface, CFGS_Google_AccessConfig $postBody, $optParams = array()) {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param CFGS_Google_Instance $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Operation
     */
    public function insert($project, CFGS_Google_Instance $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class CFGS_Google_MachineTypesServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @return CFGS_Google_MachineTypeList
     */
    public function listMachineTypes($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_MachineTypeList($data);
      } else {
        return $data;
      }
    }
     ...
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_MachineType
     */
    public function get($project, $machineType, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_MachineType($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_ImagesServiceResource extends CFGS_Google_ServiceResource {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param CFGS_Google_Image $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Operation
     */
    public function insert($project, CFGS_Google_Image $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
    ...
    public function get($project, $image, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Image($data);
      } else {
        return $data;
      }
    }
    ...
    public function listImages($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_ImageList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_FirewallsServiceResource extends CFGS_Google_ServiceResource {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param CFGS_Google_Firewall $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Operation
     */
    public function insert($project, CFGS_Google_Firewall $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
    ...
    public function get($project, $firewall, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Firewall($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @return CFGS_Google_FirewallList
     */
    public function listFirewalls($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_FirewallList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Operation
     */
    public function update($project, $firewall, CFGS_Google_Firewall $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_Operation
     */
    public function patch($project, $firewall, CFGS_Google_Firewall $postBody, $optParams = array()) {
      $params = array('project' => $project, 'firewall' => $firewall, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CFGS_Google_NetworksServiceResource extends CFGS_Google_ServiceResource {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param CFGS_Google_Network $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Operation
     */
    public function insert($project, CFGS_Google_Network $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
    ...
    public function get($project, $network, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Network($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @return CFGS_Google_NetworkList
     */
    public function listNetworks($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_NetworkList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_ProjectsServiceResource extends CFGS_Google_ServiceResource {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param CFGS_Google_Metadata $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Operation
     */
    public function setCommonInstanceMetadata($project, CFGS_Google_Metadata $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
    ...
    public function get($project, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Project($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for CFGS_Google_Compute (v1beta13).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_ComputeService extends CFGS_Google_Service {
  public $operations;
  public $kernels;
  public $disks;
  public $snapshots;
...
class CFGS_Google_AttachedDisk extends CFGS_Google_Model {
  public $deviceName;
  public $kind;
  public $index;
  public $source;
...
class CFGS_Google_Disk extends CFGS_Google_Model {
  public $status;
...
class CFGS_Google_DiskList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Disk';
  ...
  public function setItems(/* array(CFGS_Google_Disk) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Disk', __METHOD__);
    $this->items = $items;
  }
...
class CFGS_Google_Firewall extends CFGS_Google_Model {
  public $kind;
  public $description;
  public $sourceTags;
  public $sourceRanges;
  public $network;
  public $targetTags;
  protected $__allowedType = 'CFGS_Google_FirewallAllowed';
  ...
  public function setAllowed(/* array(CFGS_Google_FirewallAllowed) */ $allowed) {
    $this->assertIsArray($allowed, 'CFGS_Google_FirewallAllowed', __METHOD__);
...
class CFGS_Google_FirewallAllowed extends CFGS_Google_Model {
  public $IPProtocol;
  public $ports;
...
class CFGS_Google_FirewallList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Firewall';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(CFGS_Google_Firewall) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Firewall', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Image extends CFGS_Google_Model {
  public $kind;
  public $description;
  protected $__rawDiskType = 'CFGS_Google_ImageRawDisk';
  protected $__rawDiskDataType = '';
  public $rawDisk;
  public $preferredKernel;
  protected $__diskSnapshotType = 'CFGS_Google_ImageDiskSnapshot';
  ...
  public function setRawDisk(CFGS_Google_ImageRawDisk $rawDisk) {
  ...
  public function setDiskSnapshot(CFGS_Google_ImageDiskSnapshot $diskSnapshot) {
...
class CFGS_Google_ImageDiskSnapshot extends CFGS_Google_Model {
  public $source;
  public function setSource($source) {
    $this->source = $source;
  }
...
class CFGS_Google_ImageList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Image';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(CFGS_Google_Image) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Image', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_ImageRawDisk extends CFGS_Google_Model {
...
class CFGS_Google_Instance extends CFGS_Google_Model {
  public $status;
  public $kind;
  public $machineType;
  public $description;
  ...
  public $tags;
  public $image;
  protected $__disksType = 'CFGS_Google_AttachedDisk';
  protected $__disksDataType = 'array';
  public $disks;
  public $name;
  public $statusMessage;
  protected $__serviceAccountsType = 'CFGS_Google_ServiceAccount';
  protected $__serviceAccountsDataType = 'array';
  public $serviceAccounts;
  protected $__networkInterfacesType = 'CFGS_Google_NetworkInterface';
  protected $__networkInterfacesDataType = 'array';
  public $networkInterfaces;
  public $creationTimestamp;
  public $id;
  public $selfLink;
  protected $__metadataType = 'CFGS_Google_Metadata';
  ...
  public function setDisks(/* array(CFGS_Google_AttachedDisk) */ $disks) {
    $this->assertIsArray($disks, 'CFGS_Google_AttachedDisk', __METHOD__);
    $this->disks = $disks;
  }
  ...
  public function setServiceAccounts(/* array(CFGS_Google_ServiceAccount) */ $serviceAccounts) {
    $this->assertIsArray($serviceAccounts, 'CFGS_Google_ServiceAccount', __METHOD__);
    $this->serviceAccounts = $serviceAccounts;
  }
  public function getServiceAccounts() {
    return $this->serviceAccounts;
  }
  public function setNetworkInterfaces(/* array(CFGS_Google_NetworkInterface) */ $networkInterfaces) {
    $this->assertIsArray($networkInterfaces, 'CFGS_Google_NetworkInterface', __METHOD__);
  ...
  public function setMetadata(CFGS_Google_Metadata $metadata) {
...
class CFGS_Google_InstanceList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Instance';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(CFGS_Google_Instance) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Instance', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Kernel extends CFGS_Google_Model {
  public $kind;
  public $description;
  public $creationTimestamp;
  public $id;
...
class CFGS_Google_KernelList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Kernel';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(CFGS_Google_Kernel) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Kernel', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_MachineType extends CFGS_Google_Model {
  public $guestCpus;
  public $imageSpaceGb;
  public $kind;
  protected $__ephemeralDisksType = 'CFGS_Google_MachineTypeEphemeralDisks';
  ...
  public function setEphemeralDisks(/* array(CFGS_Google_MachineTypeEphemeralDisks) */ $ephemeralDisks) {
    $this->assertIsArray($ephemeralDisks, 'CFGS_Google_MachineTypeEphemeralDisks', __METHOD__);
...
class CFGS_Google_MachineTypeEphemeralDisks extends CFGS_Google_Model {
  public $diskGb;
...
class CFGS_Google_MachineTypeList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_MachineType';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(CFGS_Google_MachineType) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_MachineType', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Metadata extends CFGS_Google_Model {
  protected $__itemsType = 'CFGS_Google_MetadataItems';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CFGS_Google_MetadataItems) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_MetadataItems', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_MetadataItems extends CFGS_Google_Model {
  public $value;
  public $key;
...
class CFGS_Google_Network extends CFGS_Google_Model {
  public $kind;
  public $description;
  public $IPv4Range;
  public $gatewayIPv4;
...
class CFGS_Google_NetworkInterface extends CFGS_Google_Model {
  public $network;
  protected $__accessConfigsType = 'CFGS_Google_AccessConfig';
  ...
  public function setAccessConfigs(/* array(CFGS_Google_AccessConfig) */ $accessConfigs) {
    $this->assertIsArray($accessConfigs, 'CFGS_Google_AccessConfig', __METHOD__);
...
class CFGS_Google_NetworkList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Network';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(CFGS_Google_Network) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Network', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Operation extends CFGS_Google_Model {
  public $status;
  public $kind;
  public $name;
  public $startTime;
  ...
  public $user;
  protected $__errorType = 'CFGS_Google_OperationError';
  ...
  public function setError(CFGS_Google_OperationError $error) {
    $this->error = $error;
  }
...
class CFGS_Google_OperationError extends CFGS_Google_Model {
  protected $__errorsType = 'CFGS_Google_OperationErrorErrors';
  protected $__errorsDataType = 'array';
  public $errors;
  public function setErrors(/* array(CFGS_Google_OperationErrorErrors) */ $errors) {
    $this->assertIsArray($errors, 'CFGS_Google_OperationErrorErrors', __METHOD__);
    $this->errors = $errors;
  }
...
class CFGS_Google_OperationErrorErrors extends CFGS_Google_Model {
  public $message;
  public $code;
  public $location;
...
class CFGS_Google_OperationList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Operation';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(CFGS_Google_Operation) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Operation', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Project extends CFGS_Google_Model {
  public $kind;
  public $description;
  protected $__commonInstanceMetadataType = 'CFGS_Google_Metadata';
  protected $__commonInstanceMetadataDataType = '';
  public $commonInstanceMetadata;
  public $externalIpAddresses;
  protected $__quotasType = 'CFGS_Google_ProjectQuotas';
  ...
  public function setCommonInstanceMetadata(CFGS_Google_Metadata $commonInstanceMetadata) {
  ...
  public function setQuotas(/* array(CFGS_Google_ProjectQuotas) */ $quotas) {
    $this->assertIsArray($quotas, 'CFGS_Google_ProjectQuotas', __METHOD__);
    $this->quotas = $quotas;
  }
...
class CFGS_Google_ProjectQuotas extends CFGS_Google_Model {
  public $usage;
  public $metric;
  public $limit;
...
class CFGS_Google_SerialPortOutput extends CFGS_Google_Model {
  public $kind;
  public $selfLink;
  public $contents;
  public function setKind($kind) {
...
class CFGS_Google_ServiceAccount extends CFGS_Google_Model {
  public $scopes;
  public $kind;
  public $email;
...
class CFGS_Google_Snapshot extends CFGS_Google_Model {
  public $status;
  public $kind;
  public $description;
  public $sourceDisk;
...
class CFGS_Google_SnapshotList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Snapshot';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(CFGS_Google_Snapshot) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Snapshot', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Zone extends CFGS_Google_Model {
  public $status;
  public $kind;
  public $availableMachineType;
  public $description;
  protected $__maintenanceWindowsType = 'CFGS_Google_ZoneMaintenanceWindows';
  ...
  public function setMaintenanceWindows(/* array(CFGS_Google_ZoneMaintenanceWindows) */ $maintenanceWindows) {
    $this->assertIsArray($maintenanceWindows, 'CFGS_Google_ZoneMaintenanceWindows', __METHOD__);
...
class CFGS_Google_ZoneList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Zone';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(CFGS_Google_Zone) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Zone', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_ZoneMaintenanceWindows extends CFGS_Google_Model {
  public $endTime;
  public $beginTime;
  public $name;
  public $description;
