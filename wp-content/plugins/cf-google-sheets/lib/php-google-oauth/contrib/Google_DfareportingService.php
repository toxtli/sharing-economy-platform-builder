 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $dfareportingService = new CFGS_Google_DfareportingService(...);
   *   $dimensionValues = $dfareportingService->dimensionValues;
   *  </code>
   */
  class CFGS_Google_DimensionValuesServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_DimensionValueRequest $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param int maxResults Maximum number of results to return.
     * @opt_param string pageToken The value of the nextToken from the previous result page.
     * @return CFGS_Google_DimensionValueList
     */
    public function query($profileId, CFGS_Google_DimensionValueRequest $postBody, $optParams = array()) {
      $params = array('profileId' => $profileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('query', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_DimensionValueList($data);
      } else {
        return $data;
      }
    }
  ...
  class CFGS_Google_ReportsServiceResource extends CFGS_Google_ServiceResource {
     ...
     *
     * @param string $profileId The DFA user profile ID.
     * @param CFGS_Google_Report $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Report
     */
    public function insert($profileId, CFGS_Google_Report $postBody, $optParams = array()) {
      $params = array('profileId' => $profileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
    ...
    public function listReports($profileId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_ReportList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Report
     */
    public function patch($profileId, $reportId, CFGS_Google_Report $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_DfareportingFile
     */
    public function run($profileId, $reportId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_DfareportingFile($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Report
     */
    public function update($profileId, $reportId, CFGS_Google_Report $postBody, $optParams = array()) {
      $params = array('profileId' => $profileId, 'reportId' => $reportId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CFGS_Google_ReportsFilesServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_UserProfilesServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_UserProfile
     */
    public function get($profileId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_UserProfile($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_UserProfileList
     */
    public function listUserProfiles($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_UserProfileList($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for CFGS_Google_Dfareporting (v1.1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_DfareportingService extends CFGS_Google_Service {
...
class CFGS_Google_CustomRichMediaEvents extends CFGS_Google_Model {
  protected $__filteredEventIdsType = 'CFGS_Google_DimensionValue';
  protected $__filteredEventIdsDataType = 'array';
  public $filteredEventIds;
  public $kind;
  public function setFilteredEventIds(/* array(CFGS_Google_DimensionValue) */ $filteredEventIds) {
    $this->assertIsArray($filteredEventIds, 'CFGS_Google_DimensionValue', __METHOD__);
...
class CFGS_Google_DateRange extends CFGS_Google_Model {
  public $endDate;
  public $kind;
...
class CFGS_Google_DfareportingFile extends CFGS_Google_Model {
  protected $__dateRangeType = 'CFGS_Google_DateRange';
  ...
  public $reportId;
  public $status;
  protected $__urlsType = 'CFGS_Google_DfareportingFileUrls';
  protected $__urlsDataType = '';
  public $urls;
  public function setDateRange(CFGS_Google_DateRange $dateRange) {
  ...
  public function setUrls(CFGS_Google_DfareportingFileUrls $urls) {
    $this->urls = $urls;
  }
...
class CFGS_Google_DfareportingFileUrls extends CFGS_Google_Model {
  public $apiUrl;
  public $browserUrl;
...
class CFGS_Google_DimensionFilter extends CFGS_Google_Model {
...
class CFGS_Google_DimensionValue extends CFGS_Google_Model {
  public $dimensionName;
  public $etag;
  public $id;
  public $kind;
...
class CFGS_Google_DimensionValueList extends CFGS_Google_Model {
  public $etag;
  protected $__itemsType = 'CFGS_Google_DimensionValue';
  ...
  public function setItems(/* array(CFGS_Google_DimensionValue) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_DimensionValue', __METHOD__);
    $this->items = $items;
  }
...
class CFGS_Google_DimensionValueRequest extends CFGS_Google_Model {
  public $dimensionName;
  public $endDate;
  protected $__filtersType = 'CFGS_Google_DimensionFilter';
  protected $__filtersDataType = 'array';
  public $filters;
  public $kind;
  public $startDate;
  ...
  public function setFilters(/* array(CFGS_Google_DimensionFilter) */ $filters) {
    $this->assertIsArray($filters, 'CFGS_Google_DimensionFilter', __METHOD__);
    $this->filters = $filters;
  }
  public function getFilters() {
    return $this->filters;
...
class CFGS_Google_FileList extends CFGS_Google_Model {
  public $etag;
  protected $__itemsType = 'CFGS_Google_DfareportingFile';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(CFGS_Google_DfareportingFile) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_DfareportingFile', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Recipient extends CFGS_Google_Model {
  public $deliveryType;
  public $email;
  public $kind;
...
class CFGS_Google_Report extends CFGS_Google_Model {
  public $accountId;
  protected $__activeGrpCriteriaType = 'CFGS_Google_ReportActiveGrpCriteria';
  protected $__activeGrpCriteriaDataType = '';
  public $activeGrpCriteria;
  protected $__criteriaType = 'CFGS_Google_ReportCriteria';
  protected $__criteriaDataType = '';
  public $criteria;
  protected $__crossDimensionReachCriteriaType = 'CFGS_Google_ReportCrossDimensionReachCriteria';
  protected $__crossDimensionReachCriteriaDataType = '';
  public $crossDimensionReachCriteria;
  protected $__deliveryType = 'CFGS_Google_ReportDelivery';
  protected $__deliveryDataType = '';
  public $delivery;
  public $etag;
  public $fileName;
  protected $__floodlightCriteriaType = 'CFGS_Google_ReportFloodlightCriteria';
  ...
  protected $__pathToConversionCriteriaType = 'CFGS_Google_ReportPathToConversionCriteria';
  protected $__pathToConversionCriteriaDataType = '';
  public $pathToConversionCriteria;
  protected $__reachCriteriaType = 'CFGS_Google_ReportReachCriteria';
  protected $__reachCriteriaDataType = '';
  public $reachCriteria;
  protected $__scheduleType = 'CFGS_Google_ReportSchedule';
  ...
  public function setActiveGrpCriteria(CFGS_Google_ReportActiveGrpCriteria $activeGrpCriteria) {
    $this->activeGrpCriteria = $activeGrpCriteria;
  }
  public function getActiveGrpCriteria() {
    return $this->activeGrpCriteria;
  }
  public function setCriteria(CFGS_Google_ReportCriteria $criteria) {
    $this->criteria = $criteria;
  }
  public function getCriteria() {
    return $this->criteria;
  }
  public function setCrossDimensionReachCriteria(CFGS_Google_ReportCrossDimensionReachCriteria $crossDimensionReachCriteria) {
  ...
  public function setDelivery(CFGS_Google_ReportDelivery $delivery) {
  ...
  public function setFloodlightCriteria(CFGS_Google_ReportFloodlightCriteria $floodlightCriteria) {
  ...
  public function setPathToConversionCriteria(CFGS_Google_ReportPathToConversionCriteria $pathToConversionCriteria) {
  ...
  public function setReachCriteria(CFGS_Google_ReportReachCriteria $reachCriteria) {
    $this->reachCriteria = $reachCriteria;
  }
  public function getReachCriteria() {
    return $this->reachCriteria;
  }
  public function setSchedule(CFGS_Google_ReportSchedule $schedule) {
...
class CFGS_Google_ReportActiveGrpCriteria extends CFGS_Google_Model {
  protected $__dateRangeType = 'CFGS_Google_DateRange';
  protected $__dateRangeDataType = '';
  public $dateRange;
  protected $__dimensionFiltersType = 'CFGS_Google_DimensionValue';
  protected $__dimensionFiltersDataType = 'array';
  public $dimensionFilters;
  protected $__dimensionsType = 'CFGS_Google_SortedDimension';
  ...
  public function setDimensionFilters(/* array(CFGS_Google_DimensionValue) */ $dimensionFilters) {
    $this->assertIsArray($dimensionFilters, 'CFGS_Google_DimensionValue', __METHOD__);
    $this->dimensionFilters = $dimensionFilters;
  }
  public function getDimensionFilters() {
    return $this->dimensionFilters;
  }
  public function setDimensions(/* array(CFGS_Google_SortedDimension) */ $dimensions) {
    $this->assertIsArray($dimensions, 'CFGS_Google_SortedDimension', __METHOD__);
...
class CFGS_Google_ReportCriteria extends CFGS_Google_Model {
  protected $__activitiesType = 'CFGS_Google_Activities';
  protected $__activitiesDataType = '';
  public $activities;
  protected $__customRichMediaEventsType = 'CFGS_Google_CustomRichMediaEvents';
  ...
  public $dimensions;
  public $metricNames;
  public function setActivities(CFGS_Google_Activities $activities) {
    $this->activities = $activities;
  }
  public function getActivities() {
    return $this->activities;
  }
  public function setCustomRichMediaEvents(CFGS_Google_CustomRichMediaEvents $customRichMediaEvents) {
...
class CFGS_Google_ReportCrossDimensionReachCriteria extends CFGS_Google_Model {
  protected $__breakdownType = 'CFGS_Google_SortedDimension';
  ...
  public $pivoted;
  public function setBreakdown(/* array(CFGS_Google_SortedDimension) */ $breakdown) {
    $this->assertIsArray($breakdown, 'CFGS_Google_SortedDimension', __METHOD__);
...
class CFGS_Google_ReportDelivery extends CFGS_Google_Model {
  public $emailOwner;
  public $emailOwnerDeliveryType;
  public $message;
  protected $__recipientsType = 'CFGS_Google_Recipient';
  ...
  public function setRecipients(/* array(CFGS_Google_Recipient) */ $recipients) {
    $this->assertIsArray($recipients, 'CFGS_Google_Recipient', __METHOD__);
...
class CFGS_Google_ReportFloodlightCriteria extends CFGS_Google_Model {
  protected $__dateRangeType = 'CFGS_Google_DateRange';
  protected $__dateRangeDataType = '';
  public $dateRange;
  protected $__dimensionFiltersType = 'CFGS_Google_DimensionValue';
  ...
  protected $__dimensionsDataType = 'array';
  public $dimensions;
  protected $__floodlightConfigIdType = 'CFGS_Google_DimensionValue';
  protected $__floodlightConfigIdDataType = '';
  public $floodlightConfigId;
  public $metricNames;
  protected $__reportPropertiesType = 'CFGS_Google_ReportFloodlightCriteriaReportProperties';
  ...
  public function setFloodlightConfigId(CFGS_Google_DimensionValue $floodlightConfigId) {
  ...
  public function setReportProperties(CFGS_Google_ReportFloodlightCriteriaReportProperties $reportProperties) {
...
class CFGS_Google_ReportFloodlightCriteriaReportProperties extends CFGS_Google_Model {
...
class CFGS_Google_ReportList extends CFGS_Google_Model {
  public $etag;
  protected $__itemsType = 'CFGS_Google_Report';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(CFGS_Google_Report) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Report', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_ReportPathToConversionCriteria extends CFGS_Google_Model {
  protected $__activityFiltersType = 'CFGS_Google_DimensionValue';
  protected $__activityFiltersDataType = 'array';
  public $activityFilters;
  protected $__conversionDimensionsType = 'CFGS_Google_SortedDimension';
  protected $__conversionDimensionsDataType = 'array';
  public $conversionDimensions;
  protected $__customFloodlightVariablesType = 'CFGS_Google_SortedDimension';
  ...
  public $floodlightConfigId;
  public $metricNames;
  protected $__perInteractionDimensionsType = 'CFGS_Google_SortedDimension';
  protected $__perInteractionDimensionsDataType = 'array';
  public $perInteractionDimensions;
  protected $__reportPropertiesType = 'CFGS_Google_ReportPathToConversionCriteriaReportProperties';
  protected $__reportPropertiesDataType = '';
  public $reportProperties;
  public function setActivityFilters(/* array(CFGS_Google_DimensionValue) */ $activityFilters) {
    $this->assertIsArray($activityFilters, 'CFGS_Google_DimensionValue', __METHOD__);
    $this->activityFilters = $activityFilters;
  }
  public function getActivityFilters() {
    return $this->activityFilters;
  }
  public function setConversionDimensions(/* array(CFGS_Google_SortedDimension) */ $conversionDimensions) {
    $this->assertIsArray($conversionDimensions, 'CFGS_Google_SortedDimension', __METHOD__);
    $this->conversionDimensions = $conversionDimensions;
  }
  public function getConversionDimensions() {
    return $this->conversionDimensions;
  }
  public function setCustomFloodlightVariables(/* array(CFGS_Google_SortedDimension) */ $customFloodlightVariables) {
    $this->assertIsArray($customFloodlightVariables, 'CFGS_Google_SortedDimension', __METHOD__);
  ...
  public function setPerInteractionDimensions(/* array(CFGS_Google_SortedDimension) */ $perInteractionDimensions) {
    $this->assertIsArray($perInteractionDimensions, 'CFGS_Google_SortedDimension', __METHOD__);
    $this->perInteractionDimensions = $perInteractionDimensions;
  }
  public function getPerInteractionDimensions() {
    return $this->perInteractionDimensions;
  }
  public function setReportProperties(CFGS_Google_ReportPathToConversionCriteriaReportProperties $reportProperties) {
    $this->reportProperties = $reportProperties;
  }
  public function getReportProperties() {
    return $this->reportProperties;
...
class CFGS_Google_ReportPathToConversionCriteriaReportProperties extends CFGS_Google_Model {
...
class CFGS_Google_ReportReachCriteria extends CFGS_Google_Model {
  protected $__activitiesType = 'CFGS_Google_Activities';
  protected $__activitiesDataType = '';
  public $activities;
  protected $__customRichMediaEventsType = 'CFGS_Google_CustomRichMediaEvents';
...
class CFGS_Google_ReportSchedule extends CFGS_Google_Model {
  public $active;
  public $every;
...
class CFGS_Google_SortedDimension extends CFGS_Google_Model {
  public $kind;
  public $name;
  public $sortOrder;
  public function setKind($kind) {
...
class CFGS_Google_UserProfile extends CFGS_Google_Model {
  public $accountId;
  public $accountName;
  public $etag;
  public $kind;
...
class CFGS_Google_UserProfileList extends CFGS_Google_Model {
  public $etag;
  protected $__itemsType = 'CFGS_Google_UserProfile';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setEtag($etag) {
  ...
  public function setItems(/* array(CFGS_Google_UserProfile) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_UserProfile', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
