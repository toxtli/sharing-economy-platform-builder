 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $adexchangebuyerService = new CFGS_Google_AdexchangebuyerService(...);
  ...
  class CFGS_Google_AccountsServiceResource extends CFGS_Google_ServiceResource {
     ...
     *
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_AccountsList
     */
    public function listAccounts($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_AccountsList($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param int $id The account id
     * @param CFGS_Google_Account $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Account
     */
    public function patch($id, CFGS_Google_Account $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_Account
     */
    public function update($id, CFGS_Google_Account $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CFGS_Google_CreativesServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function get($accountId, $buyerCreativeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Creative($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param CFGS_Google_Creative $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Creative
     */
    public function insert(CFGS_Google_Creative $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_CreativesList
     */
    public function listCreatives($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_CreativesList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_DirectDealsServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function get($id, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_DirectDeal($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_DirectDealsList
     */
    public function listDirectDeals($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_DirectDealsList($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for CFGS_Google_Adexchangebuyer (v1.1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_AdexchangebuyerService extends CFGS_Google_Service {
  public $accounts;
  public $creatives;
  public $directDeals;
  /**
...
class CFGS_Google_Account extends CFGS_Google_Model {
  ...
  public function setBidderLocation(/* array(CFGS_Google_AccountBidderLocation) */ $bidderLocation) {
    $this->assertIsArray($bidderLocation, 'CFGS_Google_AccountBidderLocation', __METHOD__);
...
class CFGS_Google_AccountBidderLocation extends CFGS_Google_Model {
  public $maximumQps;
  public $region;
  public $url;
...
class CFGS_Google_AccountsList extends CFGS_Google_Model {
...
class CFGS_Google_Creative extends CFGS_Google_Model {
  public $HTMLSnippet;
  public $accountId;
  public $advertiserId;
...
class CFGS_Google_CreativesList extends CFGS_Google_Model {
  protected $__itemsType = 'CFGS_Google_Creative';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  public function setItems(/* array(CFGS_Google_Creative) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Creative', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_DirectDeal extends CFGS_Google_Model {
  public $accountId;
  public $advertiser;
  public $currencyCode;
  public $endTime;
...
class CFGS_Google_DirectDealsList extends CFGS_Google_Model {
  protected $__directDealsType = 'CFGS_Google_DirectDeal';
  protected $__directDealsDataType = 'array';
  public $directDeals;
  public $kind;
  public function setDirectDeals(/* array(CFGS_Google_DirectDeal) */ $directDeals) {
    $this->assertIsArray($directDeals, 'CFGS_Google_DirectDeal', __METHOD__);
