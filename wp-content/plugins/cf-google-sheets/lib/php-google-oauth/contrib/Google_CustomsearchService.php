 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $customsearchService = new CFGS_Google_CustomsearchService(...);
   *   $cse = $customsearchService->cse;
   *  </code>
   */
  class CFGS_Google_CseServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function listCse($q, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_Search($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for CFGS_Google_Customsearch (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_CustomsearchService extends CFGS_Google_Service {
  public $cse;
  /**
...
class CFGS_Google_ContextFacets extends CFGS_Google_Model {
  public $anchor;
  public $label;
...
class CFGS_Google_Promotion extends CFGS_Google_Model {
  public $title;
  public $displayLink;
  public $htmlTitle;
  public $link;
  protected $__bodyLinesType = 'CFGS_Google_PromotionBodyLines';
  protected $__bodyLinesDataType = 'array';
  public $bodyLines;
  protected $__imageType = 'CFGS_Google_PromotionImage';
  ...
  public function setBodyLines(/* array(CFGS_Google_PromotionBodyLines) */ $bodyLines) {
    $this->assertIsArray($bodyLines, 'CFGS_Google_PromotionBodyLines', __METHOD__);
    $this->bodyLines = $bodyLines;
  }
  public function getBodyLines() {
    return $this->bodyLines;
  }
  public function setImage(CFGS_Google_PromotionImage $image) {
    $this->image = $image;
  }
...
class CFGS_Google_PromotionBodyLines extends CFGS_Google_Model {
  public $url;
  public $htmlTitle;
  public $link;
  public $title;
...
class CFGS_Google_PromotionImage extends CFGS_Google_Model {
  public $source;
  public $width;
  public $height;
...
class CFGS_Google_Query extends CFGS_Google_Model {
  public $sort;
...
class CFGS_Google_Result extends CFGS_Google_Model {
  public $snippet;
  public $kind;
  protected $__labelsType = 'CFGS_Google_ResultLabels';
  ...
  public $htmlSnippet;
  public $link;
  protected $__imageType = 'CFGS_Google_ResultImage';
  protected $__imageDataType = '';
  public $image;
  public $mime;
  public $fileFormat;
  ...
  public function setLabels(/* array(CFGS_Google_ResultLabels) */ $labels) {
    $this->assertIsArray($labels, 'CFGS_Google_ResultLabels', __METHOD__);
    $this->labels = $labels;
  }
  ...
  public function setImage(CFGS_Google_ResultImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class CFGS_Google_ResultImage extends CFGS_Google_Model {
...
class CFGS_Google_ResultLabels extends CFGS_Google_Model {
  public $displayName;
  public $name;
...
class CFGS_Google_Search extends CFGS_Google_Model {
  protected $__promotionsType = 'CFGS_Google_Promotion';
  protected $__promotionsDataType = 'array';
  public $promotions;
  public $kind;
  protected $__urlType = 'CFGS_Google_SearchUrl';
  protected $__urlDataType = '';
  public $url;
  protected $__itemsType = 'CFGS_Google_Result';
  protected $__itemsDataType = 'array';
  public $items;
  protected $__contextType = 'CFGS_Google_Context';
  protected $__contextDataType = '';
  public $context;
  protected $__queriesType = 'CFGS_Google_Query';
  protected $__queriesDataType = 'map';
  public $queries;
  protected $__spellingType = 'CFGS_Google_SearchSpelling';
  protected $__spellingDataType = '';
  public $spelling;
  protected $__searchInformationType = 'CFGS_Google_SearchSearchInformation';
  protected $__searchInformationDataType = '';
  public $searchInformation;
  public function setPromotions(/* array(CFGS_Google_Promotion) */ $promotions) {
    $this->assertIsArray($promotions, 'CFGS_Google_Promotion', __METHOD__);
  ...
  public function setUrl(CFGS_Google_SearchUrl $url) {
    $this->url = $url;
  }
  public function getUrl() {
    return $this->url;
  }
  public function setItems(/* array(CFGS_Google_Result) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Result', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
  }
  public function setContext(CFGS_Google_Context $context) {
    $this->context = $context;
  }
  public function getContext() {
    return $this->context;
  }
  public function setQueries(CFGS_Google_Query $queries) {
    $this->queries = $queries;
  }
  public function getQueries() {
    return $this->queries;
  }
  public function setSpelling(CFGS_Google_SearchSpelling $spelling) {
    $this->spelling = $spelling;
  }
  public function getSpelling() {
    return $this->spelling;
  }
  public function setSearchInformation(CFGS_Google_SearchSearchInformation $searchInformation) {
...
class CFGS_Google_SearchSearchInformation extends CFGS_Google_Model {
...
class CFGS_Google_SearchSpelling extends CFGS_Google_Model {
...
class CFGS_Google_SearchUrl extends CFGS_Google_Model {
  public $type;
  public $template;
