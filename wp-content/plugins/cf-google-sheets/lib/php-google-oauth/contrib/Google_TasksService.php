 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $tasksService = new CFGS_Google_TasksService(...);
  ...
  class CFGS_Google_TasksServiceResource extends CFGS_Google_ServiceResource {
     ...
     */
    public function insert($tasklist, CFGS_Google_Task $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_Task
     */
    public function update($tasklist, $task, CFGS_Google_Task $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_Task
     */
    public function patch($tasklist, $task, CFGS_Google_Task $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CFGS_Google_TasklistsServiceResource extends CFGS_Google_ServiceResource {


    /**
     * Creates a new task list and adds it to the authenticated user's task lists. (tasklists.insert)
     *
     * @param CFGS_Google_TaskList $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_TaskList
     */
    public function insert(CFGS_Google_TaskList $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_TaskList($data);
      } else {
        return $data;
      }
    }
    ...
    public function listTasklists($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_TaskLists($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_TaskList
     */
    public function update($tasklist, CFGS_Google_TaskList $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return CFGS_Google_TaskList
     */
    public function patch($tasklist, CFGS_Google_TaskList $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
...
/**
 * Service definition for CFGS_Google_Tasks (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_TasksService extends CFGS_Google_Service {
  public $tasks;
  public $tasklists;
  /**
...
class CFGS_Google_Task extends CFGS_Google_Model {
  ...
  public $updated;
  public $parent;
  protected $__linksType = 'CFGS_Google_TaskLinks';
  ...
  public function setLinks(/* array(CFGS_Google_TaskLinks) */ $links) {
    $this->assertIsArray($links, 'CFGS_Google_TaskLinks', __METHOD__);
    $this->links = $links;
  }
...
class CFGS_Google_TaskLinks extends CFGS_Google_Model {
  public $type;
  public $link;
  public $description;
...
class CFGS_Google_TaskList extends CFGS_Google_Model {
  public $kind;
  public $title;
  public $updated;
  public $etag;
...
class CFGS_Google_TaskLists extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_TaskList';
  ...
  public function setItems(/* array(CFGS_Google_TaskList) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_TaskList', __METHOD__);
    $this->items = $items;
  }
