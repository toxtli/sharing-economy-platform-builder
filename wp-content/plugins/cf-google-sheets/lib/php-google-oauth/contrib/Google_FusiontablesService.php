 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $fusiontablesService = new CFGS_Google_FusiontablesService(...);
   *   $column = $fusiontablesService->column;
   *  </code>
   */
  class CFGS_Google_ColumnServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_Column $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Column
     */
    public function insert($tableId, CFGS_Google_Column $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Column($data);
      } else {
        return $data;
      }
    }
    ...
    public function listColumn($tableId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_ColumnList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Column
     */
    public function update($tableId, $columnId, CFGS_Google_Column $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_Column
     */
    public function patch($tableId, $columnId, CFGS_Google_Column $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'columnId' => $columnId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CFGS_Google_QueryServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @return CFGS_Google_Sqlresponse
     */
    public function sqlGet($sql, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_Sqlresponse($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_StyleServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_StyleSetting $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_StyleSetting
     */
    public function insert($tableId, CFGS_Google_StyleSetting $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_StyleSetting($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_StyleSettingList
     */
    public function listStyle($tableId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_StyleSettingList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_StyleSetting
     */
    public function update($tableId, $styleId, CFGS_Google_StyleSetting $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_StyleSetting
     */
    public function patch($tableId, $styleId, CFGS_Google_StyleSetting $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'styleId' => $styleId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class CFGS_Google_TemplateServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_Template $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Template
     */
    public function insert($tableId, CFGS_Google_Template $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Template($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_TemplateList
     */
    public function listTemplate($tableId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_TemplateList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Template
     */
    public function update($tableId, $templateId, CFGS_Google_Template $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_Template
     */
    public function patch($tableId, $templateId, CFGS_Google_Template $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'templateId' => $templateId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class CFGS_Google_TableServiceResource extends CFGS_Google_ServiceResource {
     ...
     */
    public function insert(CFGS_Google_Table $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_Table
     */
    public function update($tableId, CFGS_Google_Table $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return CFGS_Google_Table
     */
    public function patch($tableId, CFGS_Google_Table $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
...
/**
 * Service definition for CFGS_Google_Fusiontables (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_FusiontablesService extends CFGS_Google_Service {
  public $column;
  public $query;
  public $style;
  public $template;
...
class CFGS_Google_Column extends CFGS_Google_Model {
  public $kind;
  public $type;
  public $columnId;
  public $name;
  protected $__baseColumnType = 'CFGS_Google_ColumnBaseColumn';
  ...
  public function setBaseColumn(CFGS_Google_ColumnBaseColumn $baseColumn) {
...
class CFGS_Google_ColumnBaseColumn extends CFGS_Google_Model {
  public $tableIndex;
  public $columnId;
...
class CFGS_Google_ColumnList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Column';
  ...
  public function setItems(/* array(CFGS_Google_Column) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Column', __METHOD__);
    $this->items = $items;
  }
...
class CFGS_Google_Geometry extends CFGS_Google_Model {
  public $geometry;
  public $type;
  public $geometries;
  ...
  public function setGeometries(/* array(CFGS_Google_object) */ $geometries) {
    $this->assertIsArray($geometries, 'CFGS_Google_object', __METHOD__);
...
class CFGS_Google_Line extends CFGS_Google_Model {
  public $type;
  public $coordinates;
  public function setType($type) {
    $this->type = $type;
  ...
  public function setCoordinates(/* array(CFGS_Google_double) */ $coordinates) {
    $this->assertIsArray($coordinates, 'CFGS_Google_double', __METHOD__);
...
class CFGS_Google_LineStyle extends CFGS_Google_Model {
  public $strokeWeight;
  protected $__strokeWeightStylerType = 'CFGS_Google_StyleFunction';
  protected $__strokeWeightStylerDataType = '';
  public $strokeWeightStyler;
  public $strokeColor;
  public $strokeOpacity;
  protected $__strokeColorStylerType = 'CFGS_Google_StyleFunction';
  ...
  public function setStrokeWeightStyler(CFGS_Google_StyleFunction $strokeWeightStyler) {
  ...
  public function setStrokeColorStyler(CFGS_Google_StyleFunction $strokeColorStyler) {
...
class CFGS_Google_Point extends CFGS_Google_Model {
  public $type;
  public $coordinates;
  public function setType($type) {
    $this->type = $type;
...
class CFGS_Google_PointStyle extends CFGS_Google_Model {
  protected $__iconStylerType = 'CFGS_Google_StyleFunction';
  protected $__iconStylerDataType = '';
  public $iconStyler;
  public $iconName;
  public function setIconStyler(CFGS_Google_StyleFunction $iconStyler) {
...
class CFGS_Google_Polygon extends CFGS_Google_Model {
  public $type;
  public $coordinates;
  public function setType($type) {
    $this->type = $type;
...
class CFGS_Google_PolygonStyle extends CFGS_Google_Model {
  protected $__strokeColorStylerType = 'CFGS_Google_StyleFunction';
  protected $__strokeColorStylerDataType = '';
  public $strokeColorStyler;
  public $strokeWeight;
  ...
  protected $__strokeWeightStylerDataType = '';
  public $strokeWeightStyler;
  protected $__fillColorStylerType = 'CFGS_Google_StyleFunction';
  ...
  public function setFillColorStyler(CFGS_Google_StyleFunction $fillColorStyler) {
...
class CFGS_Google_Sqlresponse extends CFGS_Google_Model {
  public $kind;
  public $rows;
  public $columns;
  public function setKind($kind) {
  ...
  public function setRows(/* array(CFGS_Google_object) */ $rows) {
    $this->assertIsArray($rows, 'CFGS_Google_object', __METHOD__);
    $this->rows = $rows;
  }
  public function getRows() {
    return $this->rows;
  }
  public function setColumns(/* array(CFGS_Google_string) */ $columns) {
    $this->assertIsArray($columns, 'CFGS_Google_string', __METHOD__);
...
class CFGS_Google_StyleFunction extends CFGS_Google_Model {
  protected $__gradientType = 'CFGS_Google_StyleFunctionGradient';
  protected $__gradientDataType = '';
  public $gradient;
  public $columnName;
  protected $__bucketsType = 'CFGS_Google_Bucket';
  protected $__bucketsDataType = 'array';
  public $buckets;
  public $kind;
  public function setGradient(CFGS_Google_StyleFunctionGradient $gradient) {
  ...
  public function setBuckets(/* array(CFGS_Google_Bucket) */ $buckets) {
    $this->assertIsArray($buckets, 'CFGS_Google_Bucket', __METHOD__);
...
class CFGS_Google_StyleFunctionGradient extends CFGS_Google_Model {
  public $max;
  protected $__colorsType = 'CFGS_Google_StyleFunctionGradientColors';
  ...
  public function setColors(/* array(CFGS_Google_StyleFunctionGradientColors) */ $colors) {
    $this->assertIsArray($colors, 'CFGS_Google_StyleFunctionGradientColors', __METHOD__);
    $this->colors = $colors;
  }
...
class CFGS_Google_StyleFunctionGradientColors extends CFGS_Google_Model {
  public $color;
  public $opacity;
  public function setColor($color) {
    $this->color = $color;
...
class CFGS_Google_StyleSetting extends CFGS_Google_Model {
  protected $__markerOptionsType = 'CFGS_Google_PointStyle';
  protected $__markerOptionsDataType = '';
  public $markerOptions;
  public $kind;
  public $name;
  protected $__polygonOptionsType = 'CFGS_Google_PolygonStyle';
  protected $__polygonOptionsDataType = '';
  public $polygonOptions;
  public $isDefaultForTable;
  protected $__polylineOptionsType = 'CFGS_Google_LineStyle';
  protected $__polylineOptionsDataType = '';
  public $polylineOptions;
  public $tableId;
  public $styleId;
  public function setMarkerOptions(CFGS_Google_PointStyle $markerOptions) {
  ...
  public function setPolygonOptions(CFGS_Google_PolygonStyle $polygonOptions) {
  ...
  public function setPolylineOptions(CFGS_Google_LineStyle $polylineOptions) {
...
class CFGS_Google_StyleSettingList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_StyleSetting';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(CFGS_Google_StyleSetting) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_StyleSetting', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Table extends CFGS_Google_Model {
  ...
  public $sql;
  public $tableId;
  protected $__columnsType = 'CFGS_Google_Column';
  ...
  public function setBaseTableIds(/* array(CFGS_Google_string) */ $baseTableIds) {
    $this->assertIsArray($baseTableIds, 'CFGS_Google_string', __METHOD__);
  ...
  public function setColumns(/* array(CFGS_Google_Column) */ $columns) {
    $this->assertIsArray($columns, 'CFGS_Google_Column', __METHOD__);
    $this->columns = $columns;
  }
  public function getColumns() {
    return $this->columns;
...
class CFGS_Google_TableList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Table';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setNextPageToken($nextPageToken) {
  ...
  public function setItems(/* array(CFGS_Google_Table) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Table', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Template extends CFGS_Google_Model {
  public $body;
  public $kind;
  public $name;
  ...
  public function setAutomaticColumnNames(/* array(CFGS_Google_string) */ $automaticColumnNames) {
    $this->assertIsArray($automaticColumnNames, 'CFGS_Google_string', __METHOD__);
...
class CFGS_Google_TemplateList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Template';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(CFGS_Google_Template) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Template', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
