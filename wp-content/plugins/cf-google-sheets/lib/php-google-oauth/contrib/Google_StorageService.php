 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $storageService = new CFGS_Google_StorageService(...);
   *   $objectAccessControls = $storageService->objectAccessControls;
   *  </code>
   */
  class CFGS_Google_ObjectAccessControlsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_ObjectAccessControl $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_ObjectAccessControl
     */
    public function insert($bucket, $object, CFGS_Google_ObjectAccessControl $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'object' => $object, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_ObjectAccessControl($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $object Name of the object.
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_ObjectAccessControls
     */
    public function listObjectAccessControls($bucket, $object, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_ObjectAccessControls($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_ObjectAccessControl
     */
    public function update($bucket, $object, $entity, CFGS_Google_ObjectAccessControl $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_ObjectAccessControl
     */
    public function patch($bucket, $object, $entity, CFGS_Google_ObjectAccessControl $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'object' => $object, 'entity' => $entity, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CFGS_Google_BucketAccessControlsServiceResource extends CFGS_Google_ServiceResource {
     ...
     *
     * @param string $bucket Name of a bucket.
     * @param CFGS_Google_BucketAccessControl $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_BucketAccessControl
     */
    public function insert($bucket, CFGS_Google_BucketAccessControl $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_BucketAccessControl($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $bucket Name of a bucket.
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_BucketAccessControls
     */
    public function listBucketAccessControls($bucket, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_BucketAccessControls($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_BucketAccessControl
     */
    public function update($bucket, $entity, CFGS_Google_BucketAccessControl $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_BucketAccessControl
     */
    public function patch($bucket, $entity, CFGS_Google_BucketAccessControl $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'entity' => $entity, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class CFGS_Google_ObjectsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_StorageObject $postBody
     * @param array $optParams Optional parameters.
     *
     ...
     * @return CFGS_Google_StorageObject
     */
    public function insert($bucket, CFGS_Google_StorageObject $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_StorageObject($data);
      } else {
        return $data;
      }
    }
    ...
    public function listObjects($bucket, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Objects($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_StorageObject
     */
    public function update($bucket, $object, CFGS_Google_StorageObject $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'object' => $object, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return CFGS_Google_StorageObject
     */
    public function patch($bucket, $object, CFGS_Google_StorageObject $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'object' => $object, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class CFGS_Google_BucketsServiceResource extends CFGS_Google_ServiceResource {


    /**
     * Creates a new bucket. (buckets.insert)
     *
     * @param CFGS_Google_Bucket $postBody
     * @param array $optParams Optional parameters.
     *
     ...
     * @return CFGS_Google_Bucket
     */
    public function insert(CFGS_Google_Bucket $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Bucket($data);
      } else {
        return $data;
      }
    }
    ...
    public function listBuckets($projectId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Buckets($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Bucket
     */
    public function update($bucket, CFGS_Google_Bucket $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return CFGS_Google_Bucket
     */
    public function patch($bucket, CFGS_Google_Bucket $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
...
/**
 * Service definition for CFGS_Google_Storage (v1beta1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_StorageService extends CFGS_Google_Service {
...
class CFGS_Google_Bucket extends CFGS_Google_Model {
  ...
  public function setAcl(/* array(CFGS_Google_BucketAccessControl) */ $acl) {
    $this->assertIsArray($acl, 'CFGS_Google_BucketAccessControl', __METHOD__);
    $this->acl = $acl;
  }
  public function getAcl() {
    return $this->acl;
  }
  public function setDefaultObjectAcl(/* array(CFGS_Google_ObjectAccessControl) */ $defaultObjectAcl) {
    $this->assertIsArray($defaultObjectAcl, 'CFGS_Google_ObjectAccessControl', __METHOD__);
  ...
  public function setOwner(CFGS_Google_BucketOwner $owner) {
    $this->owner = $owner;
  }
...
class CFGS_Google_BucketAccessControl extends CFGS_Google_Model {
  public $domain;
  public $bucket;
  public $kind;
  public $id;
...
class CFGS_Google_BucketAccessControls extends CFGS_Google_Model {
  protected $__itemsType = 'CFGS_Google_BucketAccessControl';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CFGS_Google_BucketAccessControl) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_BucketAccessControl', __METHOD__);
    $this->items = $items;
  }
...
class CFGS_Google_BucketOwner extends CFGS_Google_Model {
  public $entityId;
  public $entity;
  public function setEntityId($entityId) {
    $this->entityId = $entityId;
...
class CFGS_Google_BucketWebsite extends CFGS_Google_Model {
  public $notFoundPage;
...
class CFGS_Google_Buckets extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Bucket';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  ...
  public function setItems(/* array(CFGS_Google_Bucket) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Bucket', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_ObjectAccessControl extends CFGS_Google_Model {
  public $domain;
  public $object;
  public $bucket;
  public $kind;
...
class CFGS_Google_ObjectAccessControls extends CFGS_Google_Model {
  protected $__itemsType = 'CFGS_Google_ObjectAccessControl';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CFGS_Google_ObjectAccessControl) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_ObjectAccessControl', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Objects extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_StorageObject';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $prefixes;
  ...
  public function setItems(/* array(CFGS_Google_StorageObject) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_StorageObject', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
  ...
  public function setPrefixes(/* array(CFGS_Google_string) */ $prefixes) {
    $this->assertIsArray($prefixes, 'CFGS_Google_string', __METHOD__);
...
class CFGS_Google_StorageObject extends CFGS_Google_Model {
  public $kind;
  public $name;
  protected $__mediaType = 'CFGS_Google_StorageObjectMedia';
  protected $__mediaDataType = '';
  public $media;
  public $bucket;
  public $contentEncoding;
  public $selfLink;
  protected $__ownerType = 'CFGS_Google_StorageObjectOwner';
  protected $__ownerDataType = '';
  public $owner;
  public $cacheControl;
  protected $__aclType = 'CFGS_Google_ObjectAccessControl';
  protected $__aclDataType = 'array';
  public $acl;
  public $id;
  ...
  public function setMedia(CFGS_Google_StorageObjectMedia $media) {
    $this->media = $media;
  }
  ...
  public function setOwner(CFGS_Google_StorageObjectOwner $owner) {
    $this->owner = $owner;
  }
  public function getOwner() {
    return $this->owner;
  ...
  public function setAcl(/* array(CFGS_Google_ObjectAccessControl) */ $acl) {
    $this->assertIsArray($acl, 'CFGS_Google_ObjectAccessControl', __METHOD__);
    $this->acl = $acl;
  }
  public function getAcl() {
    return $this->acl;
...
class CFGS_Google_StorageObjectMedia extends CFGS_Google_Model {
  public $contentType;
  public $timeCreated;
  public $algorithm;
  public $length;
...
class CFGS_Google_StorageObjectOwner extends CFGS_Google_Model {
  public $entityId;
  public $entity;
  public function setEntityId($entityId) {
    $this->entityId = $entityId;
