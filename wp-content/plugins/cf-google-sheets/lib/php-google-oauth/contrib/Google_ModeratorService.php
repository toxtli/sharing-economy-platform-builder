 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $moderatorService = new CFGS_Google_ModeratorService(...);
   *   $votes = $moderatorService->votes;
   *  </code>
   */
  class CFGS_Google_VotesServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_Vote $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param string unauthToken User identifier for unauthenticated usage mode
     * @return CFGS_Google_Vote
     */
    public function insert($seriesId, $submissionId, CFGS_Google_Vote $postBody, $optParams = array()) {
      $params = array('seriesId' => $seriesId, 'submissionId' => $submissionId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Vote($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Vote
     */
    public function patch($seriesId, $submissionId, CFGS_Google_Vote $postBody, $optParams = array()) {
      $params = array('seriesId' => $seriesId, 'submissionId' => $submissionId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
    ...
    public function listVotes($seriesId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_VoteList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Vote
     */
    public function update($seriesId, $submissionId, CFGS_Google_Vote $postBody, $optParams = array()) {
      $params = array('seriesId' => $seriesId, 'submissionId' => $submissionId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CFGS_Google_ResponsesServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_Submission $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param string unauthToken User identifier for unauthenticated usage mode
     * @opt_param bool anonymous Set to true to mark the new submission as anonymous.
     * @return CFGS_Google_Submission
     */
    public function insert($seriesId, $topicId, $parentSubmissionId, CFGS_Google_Submission $postBody, $optParams = array()) {
      $params = array('seriesId' => $seriesId, 'topicId' => $topicId, 'parentSubmissionId' => $parentSubmissionId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Submission($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_SubmissionList
     */
    public function listResponses($seriesId, $submissionId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_SubmissionList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_TagsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param string $seriesId The decimal ID of the Series.
     * @param string $submissionId The decimal ID of the Submission within the Series.
     * @param CFGS_Google_Tag $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Tag
     */
    public function insert($seriesId, $submissionId, CFGS_Google_Tag $postBody, $optParams = array()) {
      $params = array('seriesId' => $seriesId, 'submissionId' => $submissionId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Tag($data);
      } else {
        return $data;
      }
    }
    ...
    public function listTags($seriesId, $submissionId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_TagList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_SeriesServiceResource extends CFGS_Google_ServiceResource {


    /**
     * Inserts a new series. (series.insert)
     *
     * @param CFGS_Google_Series $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Series
     */
    public function insert(CFGS_Google_Series $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Series($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Series
     */
    public function patch($seriesId, CFGS_Google_Series $postBody, $optParams = array()) {
    ...
    public function listSeries($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_SeriesList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Series
     */
    public function update($seriesId, CFGS_Google_Series $postBody, $optParams = array()) {
      $params = array('seriesId' => $seriesId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class CFGS_Google_SeriesSubmissionsServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_SeriesResponsesServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_TopicsServiceResource extends CFGS_Google_ServiceResource {
     ...
     *
     * @param string $seriesId The decimal ID of the Series.
     * @param CFGS_Google_Topic $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Topic
     */
    public function insert($seriesId, CFGS_Google_Topic $postBody, $optParams = array()) {
      $params = array('seriesId' => $seriesId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Topic($data);
      } else {
        return $data;
      }
    }
    ...
    public function listTopics($seriesId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_TopicList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Topic
     */
    public function update($seriesId, $topicId, CFGS_Google_Topic $postBody, $optParams = array()) {
   ...
   *  </code>
   */
  class CFGS_Google_TopicsSubmissionsServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_ModeratorGlobalServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_ModeratorGlobalSeriesServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_ProfilesServiceResource extends CFGS_Google_ServiceResource {
     ...
     * (profiles.patch)
     *
     * @param CFGS_Google_Profile $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Profile
     */
    public function patch(CFGS_Google_Profile $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Profile($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Profile
     */
    public function update(CFGS_Google_Profile $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class CFGS_Google_FeaturedServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_FeaturedSeriesServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_MyrecentServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_MyrecentSeriesServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_MyServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_MySeriesServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_SubmissionsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @return CFGS_Google_Submission
     */
    public function insert($seriesId, $topicId, CFGS_Google_Submission $postBody, $optParams = array()) {
      $params = array('seriesId' => $seriesId, 'topicId' => $topicId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
...
/**
 * Service definition for CFGS_Google_Moderator (v1).
 *
 * <p>
 * Moderator API
 * </p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_ModeratorService extends CFGS_Google_Service {
  public $votes;
  public $responses;
  public $tags;
  public $series;
...
class CFGS_Google_ModeratorTopicsResourcePartialId extends CFGS_Google_Model {
  public $seriesId;
  public $topicId;
...
class CFGS_Google_ModeratorVotesResourcePartial extends CFGS_Google_Model {
  public $vote;
  public $flag;
...
class CFGS_Google_Profile extends CFGS_Google_Model {
  public $kind;
  protected $__attributionType = 'CFGS_Google_ProfileAttribution';
  protected $__attributionDataType = '';
  public $attribution;
  protected $__idType = 'CFGS_Google_ProfileId';
  protected $__idDataType = '';
  public $id;
  ...
  public function setAttribution(CFGS_Google_ProfileAttribution $attribution) {
    $this->attribution = $attribution;
  }
  public function getAttribution() {
    return $this->attribution;
  }
  public function setId(CFGS_Google_ProfileId $id) {
    $this->id = $id;
  }
  public function getId() {
    return $this->id;
...
class CFGS_Google_ProfileAttribution extends CFGS_Google_Model {
  protected $__geoType = 'CFGS_Google_ProfileAttributionGeo';
  protected $__geoDataType = '';
  public $geo;
  public $displayName;
  public $location;
  public $avatarUrl;
  public function setGeo(CFGS_Google_ProfileAttributionGeo $geo) {
    $this->geo = $geo;
  }
...
class CFGS_Google_ProfileAttributionGeo extends CFGS_Google_Model {
  public $latitude;
  public $location;
  public $longitude;
...
class CFGS_Google_ProfileId extends CFGS_Google_Model {
  public $user;
...
class CFGS_Google_Series extends CFGS_Google_Model {
  public $kind;
  public $description;
  protected $__rulesType = 'CFGS_Google_SeriesRules';
  ...
  protected $__idType = 'CFGS_Google_SeriesId';
  protected $__idDataType = '';
  public $id;
  protected $__countersType = 'CFGS_Google_SeriesCounters';
  ...
  public function setRules(CFGS_Google_SeriesRules $rules) {
    $this->rules = $rules;
  }
  ...
  public function setId(CFGS_Google_SeriesId $id) {
    $this->id = $id;
  }
  public function getId() {
    return $this->id;
  }
  public function setCounters(CFGS_Google_SeriesCounters $counters) {
...
class CFGS_Google_SeriesCounters extends CFGS_Google_Model {
  public $users;
  public $noneVotes;
...
class CFGS_Google_SeriesId extends CFGS_Google_Model {
  public $seriesId;
  public function setSeriesId($seriesId) {
    $this->seriesId = $seriesId;
  }
...
class CFGS_Google_SeriesList extends CFGS_Google_Model {
  protected $__itemsType = 'CFGS_Google_Series';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CFGS_Google_Series) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Series', __METHOD__);
    $this->items = $items;
  }
...
class CFGS_Google_SeriesRules extends CFGS_Google_Model {
  protected $__votesType = 'CFGS_Google_SeriesRulesVotes';
  protected $__votesDataType = '';
  public $votes;
  protected $__submissionsType = 'CFGS_Google_SeriesRulesSubmissions';
  protected $__submissionsDataType = '';
  public $submissions;
  public function setVotes(CFGS_Google_SeriesRulesVotes $votes) {
    $this->votes = $votes;
  }
  public function getVotes() {
    return $this->votes;
  }
  public function setSubmissions(CFGS_Google_SeriesRulesSubmissions $submissions) {
    $this->submissions = $submissions;
  }
  public function getSubmissions() {
    return $this->submissions;
...
class CFGS_Google_SeriesRulesSubmissions extends CFGS_Google_Model {
  public $close;
  public $open;
...
class CFGS_Google_SeriesRulesVotes extends CFGS_Google_Model {
  public $close;
  public $open;
  public function setClose($close) {
    $this->close = $close;
...
class CFGS_Google_Submission extends CFGS_Google_Model {
  public $kind;
  protected $__attributionType = 'CFGS_Google_SubmissionAttribution';
  protected $__attributionDataType = '';
  public $attribution;
  public $created;
  public $text;
  protected $__topicsType = 'CFGS_Google_ModeratorTopicsResourcePartial';
  protected $__topicsDataType = 'array';
  public $topics;
  public $author;
  protected $__translationsType = 'CFGS_Google_SubmissionTranslations';
  protected $__translationsDataType = 'array';
  public $translations;
  protected $__parentSubmissionIdType = 'CFGS_Google_SubmissionParentSubmissionId';
  protected $__parentSubmissionIdDataType = '';
  public $parentSubmissionId;
  protected $__voteType = 'CFGS_Google_ModeratorVotesResourcePartial';
  protected $__voteDataType = '';
  public $vote;
  public $attachmentUrl;
  protected $__geoType = 'CFGS_Google_SubmissionGeo';
  protected $__geoDataType = '';
  public $geo;
  protected $__idType = 'CFGS_Google_SubmissionId';
  protected $__idDataType = '';
  public $id;
  protected $__countersType = 'CFGS_Google_SubmissionCounters';
  protected $__countersDataType = '';
  public $counters;
  public function setKind($kind) {
    $this->kind = $kind;
  ...
  public function setAttribution(CFGS_Google_SubmissionAttribution $attribution) {
    $this->attribution = $attribution;
  }
  public function getAttribution() {
    return $this->attribution;
  ...
  public function setTopics(/* array(CFGS_Google_ModeratorTopicsResourcePartial) */ $topics) {
    $this->assertIsArray($topics, 'CFGS_Google_ModeratorTopicsResourcePartial', __METHOD__);
    $this->topics = $topics;
  }
  ...
  public function setTranslations(/* array(CFGS_Google_SubmissionTranslations) */ $translations) {
    $this->assertIsArray($translations, 'CFGS_Google_SubmissionTranslations', __METHOD__);
    $this->translations = $translations;
  }
  public function getTranslations() {
    return $this->translations;
  }
  public function setParentSubmissionId(CFGS_Google_SubmissionParentSubmissionId $parentSubmissionId) {
    $this->parentSubmissionId = $parentSubmissionId;
  }
  public function getParentSubmissionId() {
    return $this->parentSubmissionId;
  }
  public function setVote(CFGS_Google_ModeratorVotesResourcePartial $vote) {
    $this->vote = $vote;
  }
  public function getVote() {
    return $this->vote;
  ...
  public function setGeo(CFGS_Google_SubmissionGeo $geo) {
    $this->geo = $geo;
  }
  public function getGeo() {
    return $this->geo;
  }
  public function setId(CFGS_Google_SubmissionId $id) {
    $this->id = $id;
  }
  public function getId() {
    return $this->id;
  }
  public function setCounters(CFGS_Google_SubmissionCounters $counters) {
    $this->counters = $counters;
  }
  public function getCounters() {
    return $this->counters;
...
class CFGS_Google_SubmissionAttribution extends CFGS_Google_Model {
  public $displayName;
  public $location;
  public $avatarUrl;
  public function setDisplayName($displayName) {
...
class CFGS_Google_SubmissionCounters extends CFGS_Google_Model {
  public $noneVotes;
  public $minusVotes;
  public $plusVotes;
  public function setNoneVotes($noneVotes) {
...
class CFGS_Google_SubmissionGeo extends CFGS_Google_Model {
  public $latitude;
  public $location;
  public $longitude;
  public function setLatitude($latitude) {
...
class CFGS_Google_SubmissionId extends CFGS_Google_Model {
  public $seriesId;
  public $submissionId;
  public function setSeriesId($seriesId) {
    $this->seriesId = $seriesId;
...
class CFGS_Google_SubmissionList extends CFGS_Google_Model {
  protected $__itemsType = 'CFGS_Google_Submission';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CFGS_Google_Submission) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Submission', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_SubmissionParentSubmissionId extends CFGS_Google_Model {
  public $seriesId;
  public $submissionId;
  public function setSeriesId($seriesId) {
    $this->seriesId = $seriesId;
...
class CFGS_Google_SubmissionTranslations extends CFGS_Google_Model {
  public $lang;
  public $text;
...
class CFGS_Google_Tag extends CFGS_Google_Model {
  public $text;
  public $kind;
  protected $__idType = 'CFGS_Google_TagId';
  protected $__idDataType = '';
  public $id;
  public function setText($text) {
    $this->text = $text;
  ...
  public function setId(CFGS_Google_TagId $id) {
    $this->id = $id;
  }
  public function getId() {
    return $this->id;
...
class CFGS_Google_TagId extends CFGS_Google_Model {
  public $seriesId;
  public $tagId;
  public $submissionId;
  public function setSeriesId($seriesId) {
...
class CFGS_Google_TagList extends CFGS_Google_Model {
  protected $__itemsType = 'CFGS_Google_Tag';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CFGS_Google_Tag) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Tag', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Topic extends CFGS_Google_Model {
  public $kind;
  public $description;
  protected $__rulesType = 'CFGS_Google_TopicRules';
  protected $__rulesDataType = '';
  public $rules;
  protected $__featuredSubmissionType = 'CFGS_Google_Submission';
  protected $__featuredSubmissionDataType = '';
  public $featuredSubmission;
  public $presenter;
  protected $__countersType = 'CFGS_Google_TopicCounters';
  protected $__countersDataType = '';
  public $counters;
  protected $__idType = 'CFGS_Google_TopicId';
  protected $__idDataType = '';
  public $id;
  public $name;
  public function setKind($kind) {
  ...
  public function setRules(CFGS_Google_TopicRules $rules) {
    $this->rules = $rules;
  }
  public function getRules() {
    return $this->rules;
  }
  public function setFeaturedSubmission(CFGS_Google_Submission $featuredSubmission) {
  ...
  public function setCounters(CFGS_Google_TopicCounters $counters) {
    $this->counters = $counters;
  }
  public function getCounters() {
    return $this->counters;
  }
  public function setId(CFGS_Google_TopicId $id) {
    $this->id = $id;
  }
  public function getId() {
    return $this->id;
...
class CFGS_Google_TopicCounters extends CFGS_Google_Model {
  public $users;
  public $noneVotes;
  public $videoSubmissions;
  public $minusVotes;
...
class CFGS_Google_TopicId extends CFGS_Google_Model {
  public $seriesId;
  public $topicId;
  public function setSeriesId($seriesId) {
    $this->seriesId = $seriesId;
...
class CFGS_Google_TopicList extends CFGS_Google_Model {
  protected $__itemsType = 'CFGS_Google_Topic';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CFGS_Google_Topic) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Topic', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_TopicRules extends CFGS_Google_Model {
  protected $__votesType = 'CFGS_Google_TopicRulesVotes';
  protected $__votesDataType = '';
  public $votes;
  protected $__submissionsType = 'CFGS_Google_TopicRulesSubmissions';
  protected $__submissionsDataType = '';
  public $submissions;
  public function setVotes(CFGS_Google_TopicRulesVotes $votes) {
    $this->votes = $votes;
  }
  public function getVotes() {
    return $this->votes;
  }
  public function setSubmissions(CFGS_Google_TopicRulesSubmissions $submissions) {
    $this->submissions = $submissions;
  }
  public function getSubmissions() {
    return $this->submissions;
...
class CFGS_Google_TopicRulesSubmissions extends CFGS_Google_Model {
  public $close;
  public $open;
  public function setClose($close) {
    $this->close = $close;
...
class CFGS_Google_TopicRulesVotes extends CFGS_Google_Model {
  public $close;
  public $open;
  public function setClose($close) {
    $this->close = $close;
...
class CFGS_Google_Vote extends CFGS_Google_Model {
  public $vote;
  public $flag;
  protected $__idType = 'CFGS_Google_VoteId';
  protected $__idDataType = '';
  public $id;
  public $kind;
  public function setVote($vote) {
  ...
  public function setId(CFGS_Google_VoteId $id) {
    $this->id = $id;
  }
  public function getId() {
    return $this->id;
...
class CFGS_Google_VoteId extends CFGS_Google_Model {
  public $seriesId;
  public $submissionId;
  public function setSeriesId($seriesId) {
    $this->seriesId = $seriesId;
...
class CFGS_Google_VoteList extends CFGS_Google_Model {
  protected $__itemsType = 'CFGS_Google_Vote';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CFGS_Google_Vote) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Vote', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
