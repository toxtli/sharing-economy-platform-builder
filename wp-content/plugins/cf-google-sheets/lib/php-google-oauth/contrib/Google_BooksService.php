 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $booksService = new CFGS_Google_BooksService(...);
   *   $layers = $booksService->layers;
   *  </code>
   */
  class CFGS_Google_LayersServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @return CFGS_Google_Layersummaries
     */
    public function listLayers($volumeId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_Layersummaries($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string source String to identify the originator of this request.
     * @opt_param string contentVersion The content version for the requested volume.
     * @return CFGS_Google_Layersummary
     */
    public function get($volumeId, $summaryId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_Layersummary($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_LayersAnnotationDataServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @return CFGS_Google_Annotationsdata
     */
    public function listLayersAnnotationData($volumeId, $layerId, $contentVersion, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Annotationsdata($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string source String to identify the originator of this request.
     * @opt_param int w The requested pixel width for any images. If width is provided height must also be provided.
     * @return CFGS_Google_Annotationdata
     */
    public function get($volumeId, $layerId, $annotationDataId, $contentVersion, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Annotationdata($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_LayersVolumeAnnotationsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @return CFGS_Google_Volumeannotations
     */
    public function listLayersVolumeAnnotations($volumeId, $layerId, $contentVersion, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Volumeannotations($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string locale The locale information for the data. ISO-639-1 language and ISO-3166-1 country code. Ex: 'en_US'.
     * @opt_param string source String to identify the originator of this request.
     * @return CFGS_Google_Volumeannotation
     */
    public function get($volumeId, $layerId, $annotationId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Volumeannotation($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_BookshelvesServiceResource extends CFGS_Google_ServiceResource {
     ...
     *
     * @opt_param string source String to identify the originator of this request.
     * @return CFGS_Google_Bookshelves
     */
    public function listBookshelves($userId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Bookshelves($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($userId, $shelf, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Bookshelf($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_BookshelvesVolumesServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function listBookshelvesVolumes($userId, $shelf, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Volumes($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_MyconfigServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @opt_param string source String to identify the originator of this request.
     * @return CFGS_Google_DownloadAccesses
     */
    public function releaseDownloadAccess($volumeIds, $cpksver, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_DownloadAccesses($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @opt_param string locale ISO-639-1, ISO-3166-1 codes for message localization, i.e. en_US.
     * @return CFGS_Google_RequestAccess
     */
    public function requestAccess($source, $volumeId, $nonce, $cpksver, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_RequestAccess($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_VolumesServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function get($volumeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Volume($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_VolumesAssociatedServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_MylibraryServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_MylibraryBookshelvesServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_MylibraryBookshelvesVolumesServiceResource extends CFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class CFGS_Google_MylibraryReadingpositionsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @return CFGS_Google_ReadingPosition
     */
    public function get($volumeId, $optParams = array()) {
      $params = array('volumeId' => $volumeId);
      $params = array_merge($params, $optParams);
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_ReadingPosition($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_MylibraryAnnotationsServiceResource extends CFGS_Google_ServiceResource {


    /**
     * Inserts a new annotation. (annotations.insert)
     *
     * @param CFGS_Google_Annotation $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
     * @return CFGS_Google_Annotation
     */
    public function insert(CFGS_Google_Annotation $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Annotation($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Annotations
     */
    public function listMylibraryAnnotations($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Annotations($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Annotation
     */
    public function update($annotationId, CFGS_Google_Annotation $postBody, $optParams = array()) {
...
/**
 * Service definition for CFGS_Google_Books (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_BooksService extends CFGS_Google_Service {
  public $layers;
...
class CFGS_Google_Annotation extends CFGS_Google_Model {
  ...
  public function setCurrentVersionRanges(CFGS_Google_AnnotationCurrentVersionRanges $currentVersionRanges) {
  ...
  public function setClientVersionRanges(CFGS_Google_AnnotationClientVersionRanges $clientVersionRanges) {
  ...
  public function setPageIds(/* array(CFGS_Google_string) */ $pageIds) {
    $this->assertIsArray($pageIds, 'CFGS_Google_string', __METHOD__);
...
class CFGS_Google_AnnotationClientVersionRanges extends CFGS_Google_Model {
  public $contentVersion;
  protected $__gbTextRangeType = 'CFGS_Google_BooksAnnotationsRange';
  protected $__gbTextRangeDataType = '';
  public $gbTextRange;
  protected $__cfiRangeType = 'CFGS_Google_BooksAnnotationsRange';
  protected $__cfiRangeDataType = '';
  public $cfiRange;
  protected $__gbImageRangeType = 'CFGS_Google_BooksAnnotationsRange';
  ...
  public function setGbTextRange(CFGS_Google_BooksAnnotationsRange $gbTextRange) {
    $this->gbTextRange = $gbTextRange;
  }
  public function getGbTextRange() {
    return $this->gbTextRange;
  }
  public function setCfiRange(CFGS_Google_BooksAnnotationsRange $cfiRange) {
    $this->cfiRange = $cfiRange;
  }
  public function getCfiRange() {
    return $this->cfiRange;
  }
  public function setGbImageRange(CFGS_Google_BooksAnnotationsRange $gbImageRange) {
...
class CFGS_Google_AnnotationCurrentVersionRanges extends CFGS_Google_Model {
  public $contentVersion;
  protected $__gbTextRangeType = 'CFGS_Google_BooksAnnotationsRange';
  protected $__gbTextRangeDataType = '';
  public $gbTextRange;
...
class CFGS_Google_Annotationdata extends CFGS_Google_Model {
  ...
  public $encoded_data;
  public $layerId;
  protected $__dataType = 'CFGS_Google_BooksLayerGeoData';
  ...
  public function setData(CFGS_Google_BooksLayerGeoData $data) {
    $this->data = $data;
  }
  public function getData() {
    return $this->data;
...
class CFGS_Google_Annotations extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Annotation';
  ...
  public function setItems(/* array(CFGS_Google_Annotation) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Annotation', __METHOD__);
    $this->items = $items;
  }
...
class CFGS_Google_Annotationsdata extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Annotationdata';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(CFGS_Google_Annotationdata) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Annotationdata', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_BooksAnnotationsRange extends CFGS_Google_Model {
...
class CFGS_Google_BooksLayerGeoData extends CFGS_Google_Model {
  protected $__geoType = 'CFGS_Google_BooksLayerGeoDataGeo';
  protected $__geoDataType = '';
  public $geo;
  protected $__commonType = 'CFGS_Google_BooksLayerGeoDataCommon';
  protected $__commonDataType = '';
  public $common;
  public function setGeo(CFGS_Google_BooksLayerGeoDataGeo $geo) {
    $this->geo = $geo;
  }
  public function getGeo() {
    return $this->geo;
  }
  public function setCommon(CFGS_Google_BooksLayerGeoDataCommon $common) {
    $this->common = $common;
  }
...
class CFGS_Google_BooksLayerGeoDataCommon extends CFGS_Google_Model {
  public $lang;
...
class CFGS_Google_BooksLayerGeoDataGeo extends CFGS_Google_Model {
  public $countryCode;
  public $title;
  public $zoom;
  public $longitude;
  public $mapType;
  public $latitude;
  protected $__boundaryType = 'CFGS_Google_BooksLayerGeoDataGeoBoundary';
  protected $__boundaryDataType = 'array';
  public $boundary;
  protected $__viewportType = 'CFGS_Google_BooksLayerGeoDataGeoViewport';
  ...
  public function setBoundary(/* array(CFGS_Google_BooksLayerGeoDataGeoBoundary) */ $boundary) {
    $this->assertIsArray($boundary, 'CFGS_Google_BooksLayerGeoDataGeoBoundary', __METHOD__);
    $this->boundary = $boundary;
  }
  public function getBoundary() {
    return $this->boundary;
  }
  public function setViewport(CFGS_Google_BooksLayerGeoDataGeoViewport $viewport) {
...
class CFGS_Google_BooksLayerGeoDataGeoBoundary extends CFGS_Google_Model {
  public $latitude;
  public $longitude;
  public function setLatitude($latitude) {
    $this->latitude = $latitude;
...
class CFGS_Google_BooksLayerGeoDataGeoViewport extends CFGS_Google_Model {
  protected $__loType = 'CFGS_Google_BooksLayerGeoDataGeoViewportLo';
  protected $__loDataType = '';
  public $lo;
  protected $__hiType = 'CFGS_Google_BooksLayerGeoDataGeoViewportHi';
  protected $__hiDataType = '';
  public $hi;
  public function setLo(CFGS_Google_BooksLayerGeoDataGeoViewportLo $lo) {
    $this->lo = $lo;
  }
  public function getLo() {
    return $this->lo;
  }
  public function setHi(CFGS_Google_BooksLayerGeoDataGeoViewportHi $hi) {
    $this->hi = $hi;
  }
...
class CFGS_Google_BooksLayerGeoDataGeoViewportHi extends CFGS_Google_Model {
  public $latitude;
  public $longitude;
  public function setLatitude($latitude) {
    $this->latitude = $latitude;
...
class CFGS_Google_BooksLayerGeoDataGeoViewportLo extends CFGS_Google_Model {
  public $latitude;
  public $longitude;
  public function setLatitude($latitude) {
    $this->latitude = $latitude;
...
class CFGS_Google_Bookshelf extends CFGS_Google_Model {
  public $kind;
  public $description;
  public $created;
  public $volumeCount;
...
class CFGS_Google_Bookshelves extends CFGS_Google_Model {
  protected $__itemsType = 'CFGS_Google_Bookshelf';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CFGS_Google_Bookshelf) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Bookshelf', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_ConcurrentAccessRestriction extends CFGS_Google_Model {
  public $nonce;
  public $kind;
  public $restricted;
  public $volumeId;
...
class CFGS_Google_DownloadAccessRestriction extends CFGS_Google_Model {
  public $nonce;
  public $kind;
  public $justAcquired;
...
class CFGS_Google_DownloadAccesses extends CFGS_Google_Model {
  protected $__downloadAccessListType = 'CFGS_Google_DownloadAccessRestriction';
  protected $__downloadAccessListDataType = 'array';
  public $downloadAccessList;
  public $kind;
  public function setDownloadAccessList(/* array(CFGS_Google_DownloadAccessRestriction) */ $downloadAccessList) {
    $this->assertIsArray($downloadAccessList, 'CFGS_Google_DownloadAccessRestriction', __METHOD__);
...
class CFGS_Google_Layersummaries extends CFGS_Google_Model {
  public $totalItems;
  protected $__itemsType = 'CFGS_Google_Layersummary';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setTotalItems($totalItems) {
  ...
  public function setItems(/* array(CFGS_Google_Layersummary) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Layersummary', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Layersummary extends CFGS_Google_Model {
  public $kind;
  ...
  public function setAnnotationTypes(/* array(CFGS_Google_string) */ $annotationTypes) {
    $this->assertIsArray($annotationTypes, 'CFGS_Google_string', __METHOD__);
...
class CFGS_Google_ReadingPosition extends CFGS_Google_Model {
  public $kind;
...
class CFGS_Google_RequestAccess extends CFGS_Google_Model {
  protected $__downloadAccessType = 'CFGS_Google_DownloadAccessRestriction';
  protected $__downloadAccessDataType = '';
  public $downloadAccess;
  public $kind;
  protected $__concurrentAccessType = 'CFGS_Google_ConcurrentAccessRestriction';
  protected $__concurrentAccessDataType = '';
  public $concurrentAccess;
  public function setDownloadAccess(CFGS_Google_DownloadAccessRestriction $downloadAccess) {
  ...
  public function setConcurrentAccess(CFGS_Google_ConcurrentAccessRestriction $concurrentAccess) {
...
class CFGS_Google_Review extends CFGS_Google_Model {
  public $rating;
  public $kind;
  protected $__authorType = 'CFGS_Google_ReviewAuthor';
  protected $__authorDataType = '';
  public $author;
  public $title;
  public $volumeId;
  public $content;
  protected $__sourceType = 'CFGS_Google_ReviewSource';
  ...
  public function setAuthor(CFGS_Google_ReviewAuthor $author) {
    $this->author = $author;
  }
  ...
  public function setSource(CFGS_Google_ReviewSource $source) {
    $this->source = $source;
  }
  public function getSource() {
    return $this->source;
...
class CFGS_Google_ReviewAuthor extends CFGS_Google_Model {
  public $displayName;
...
class CFGS_Google_ReviewSource extends CFGS_Google_Model {
...
class CFGS_Google_Volume extends CFGS_Google_Model {
  public $kind;
  protected $__accessInfoType = 'CFGS_Google_VolumeAccessInfo';
  protected $__accessInfoDataType = '';
  public $accessInfo;
  protected $__searchInfoType = 'CFGS_Google_VolumeSearchInfo';
  protected $__searchInfoDataType = '';
  public $searchInfo;
  protected $__saleInfoType = 'CFGS_Google_VolumeSaleInfo';
  protected $__saleInfoDataType = '';
  public $saleInfo;
  public $etag;
  protected $__userInfoType = 'CFGS_Google_VolumeUserInfo';
  protected $__userInfoDataType = '';
  public $userInfo;
  protected $__volumeInfoType = 'CFGS_Google_VolumeVolumeInfo';
  ...
  public function setAccessInfo(CFGS_Google_VolumeAccessInfo $accessInfo) {
    $this->accessInfo = $accessInfo;
  }
  public function getAccessInfo() {
    return $this->accessInfo;
  }
  public function setSearchInfo(CFGS_Google_VolumeSearchInfo $searchInfo) {
    $this->searchInfo = $searchInfo;
  }
  public function getSearchInfo() {
    return $this->searchInfo;
  }
  public function setSaleInfo(CFGS_Google_VolumeSaleInfo $saleInfo) {
  ...
  public function setUserInfo(CFGS_Google_VolumeUserInfo $userInfo) {
    $this->userInfo = $userInfo;
  }
  public function getUserInfo() {
    return $this->userInfo;
  }
  public function setVolumeInfo(CFGS_Google_VolumeVolumeInfo $volumeInfo) {
...
class CFGS_Google_VolumeAccessInfo extends CFGS_Google_Model {
  ...
  protected $__pdfType = 'CFGS_Google_VolumeAccessInfoPdf';
  protected $__pdfDataType = '';
  public $pdf;
  public $viewability;
  protected $__epubType = 'CFGS_Google_VolumeAccessInfoEpub';
  ...
  public function setPdf(CFGS_Google_VolumeAccessInfoPdf $pdf) {
    $this->pdf = $pdf;
  }
  ...
  public function setEpub(CFGS_Google_VolumeAccessInfoEpub $epub) {
    $this->epub = $epub;
  }
...
class CFGS_Google_VolumeAccessInfoEpub extends CFGS_Google_Model {
  public $isAvailable;
  public $downloadLink;
  public $acsTokenLink;
...
class CFGS_Google_VolumeAccessInfoPdf extends CFGS_Google_Model {
  public $isAvailable;
  public $downloadLink;
  public $acsTokenLink;
  public function setIsAvailable($isAvailable) {
...
class CFGS_Google_VolumeSaleInfo extends CFGS_Google_Model {
  public $country;
  protected $__retailPriceType = 'CFGS_Google_VolumeSaleInfoRetailPrice';
  ...
  public $buyLink;
  public $onSaleDate;
  protected $__listPriceType = 'CFGS_Google_VolumeSaleInfoListPrice';
  ...
  public function setRetailPrice(CFGS_Google_VolumeSaleInfoRetailPrice $retailPrice) {
  ...
  public function setListPrice(CFGS_Google_VolumeSaleInfoListPrice $listPrice) {
...
class CFGS_Google_VolumeSaleInfoListPrice extends CFGS_Google_Model {
  public $amount;
  public $currencyCode;
...
class CFGS_Google_VolumeSaleInfoRetailPrice extends CFGS_Google_Model {
  public $amount;
  public $currencyCode;
  public function setAmount($amount) {
    $this->amount = $amount;
...
class CFGS_Google_VolumeSearchInfo extends CFGS_Google_Model {
  public $textSnippet;
...
class CFGS_Google_VolumeUserInfo extends CFGS_Google_Model {
  public $isInMyBooks;
  public $updated;
  protected $__reviewType = 'CFGS_Google_Review';
  protected $__reviewDataType = '';
  public $review;
  public $isPurchased;
  protected $__readingPositionType = 'CFGS_Google_ReadingPosition';
  ...
  public function setReview(CFGS_Google_Review $review) {
    $this->review = $review;
  }
  ...
  public function setReadingPosition(CFGS_Google_ReadingPosition $readingPosition) {
...
class CFGS_Google_VolumeVolumeInfo extends CFGS_Google_Model {
  public $publisher;
  public $subtitle;
  public $description;
  public $language;
  public $pageCount;
  protected $__imageLinksType = 'CFGS_Google_VolumeVolumeInfoImageLinks';
  ...
  public $ratingsCount;
  public $mainCategory;
  protected $__dimensionsType = 'CFGS_Google_VolumeVolumeInfoDimensions';
  protected $__dimensionsDataType = '';
  public $dimensions;
  public $contentVersion;
  protected $__industryIdentifiersType = 'CFGS_Google_VolumeVolumeInfoIndustryIdentifiers';
  ...
  public function setImageLinks(CFGS_Google_VolumeVolumeInfoImageLinks $imageLinks) {
  ...
  public function setDimensions(CFGS_Google_VolumeVolumeInfoDimensions $dimensions) {
  ...
  public function setIndustryIdentifiers(/* array(CFGS_Google_VolumeVolumeInfoIndustryIdentifiers) */ $industryIdentifiers) {
    $this->assertIsArray($industryIdentifiers, 'CFGS_Google_VolumeVolumeInfoIndustryIdentifiers', __METHOD__);
    $this->industryIdentifiers = $industryIdentifiers;
  }
  public function getIndustryIdentifiers() {
    return $this->industryIdentifiers;
  }
  public function setAuthors(/* array(CFGS_Google_string) */ $authors) {
    $this->assertIsArray($authors, 'CFGS_Google_string', __METHOD__);
  ...
  public function setCategories(/* array(CFGS_Google_string) */ $categories) {
    $this->assertIsArray($categories, 'CFGS_Google_string', __METHOD__);
...
class CFGS_Google_VolumeVolumeInfoDimensions extends CFGS_Google_Model {
  public $width;
  public $thickness;
  public $height;
...
class CFGS_Google_VolumeVolumeInfoImageLinks extends CFGS_Google_Model {
  public $medium;
...
class CFGS_Google_VolumeVolumeInfoIndustryIdentifiers extends CFGS_Google_Model {
  public $identifier;
  public $type;
...
class CFGS_Google_Volumeannotation extends CFGS_Google_Model {
  public $annotationType;
  public $kind;
  public $updated;
  public $deleted;
  protected $__contentRangesType = 'CFGS_Google_VolumeannotationContentRanges';
  ...
  public function setContentRanges(CFGS_Google_VolumeannotationContentRanges $contentRanges) {
...
class CFGS_Google_VolumeannotationContentRanges extends CFGS_Google_Model {
  public $contentVersion;
  protected $__gbTextRangeType = 'CFGS_Google_BooksAnnotationsRange';
  protected $__gbTextRangeDataType = '';
  public $gbTextRange;
...
class CFGS_Google_Volumeannotations extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CFGS_Google_Volumeannotation';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(CFGS_Google_Volumeannotation) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Volumeannotation', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CFGS_Google_Volumes extends CFGS_Google_Model {
  public $totalItems;
  protected $__itemsType = 'CFGS_Google_Volume';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setTotalItems($totalItems) {
  ...
  public function setItems(/* array(CFGS_Google_Volume) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Volume', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
