 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $bigqueryService = new CFGS_Google_BigqueryService(...);
   *   $tables = $bigqueryService->tables;
   *  </code>
   */
  class CFGS_Google_TablesServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_Table $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Table
     */
    public function insert($projectId, $datasetId, CFGS_Google_Table $postBody, $optParams = array()) {
      $params = array('projectId' => $projectId, 'datasetId' => $datasetId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Table($data);
      } else {
        return $data;
      }
    }
    ...
    public function listTables($projectId, $datasetId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_TableList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Table
     */
    public function update($projectId, $datasetId, $tableId, CFGS_Google_Table $postBody, $optParams = array()) {
     ...
     * @return CFGS_Google_Table
     */
    public function patch($projectId, $datasetId, $tableId, CFGS_Google_Table $postBody, $optParams = array()) {
      $params = array('projectId' => $projectId, 'datasetId' => $datasetId, 'tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CFGS_Google_DatasetsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_Dataset $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Dataset
     */
    public function insert($projectId, CFGS_Google_Dataset $postBody, $optParams = array()) {
      $params = array('projectId' => $projectId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Dataset($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_DatasetList
     */
    public function listDatasets($projectId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_DatasetList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_Dataset
     */
    public function update($projectId, $datasetId, CFGS_Google_Dataset $postBody, $optParams = array()) {
      $params = array('projectId' => $projectId, 'datasetId' => $datasetId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return CFGS_Google_Dataset
     */
    public function patch($projectId, $datasetId, CFGS_Google_Dataset $postBody, $optParams = array()) {
      $params = array('projectId' => $projectId, 'datasetId' => $datasetId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class CFGS_Google_JobsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @param CFGS_Google_Job $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_Job
     */
    public function insert($projectId, CFGS_Google_Job $postBody, $optParams = array()) {
      $params = array('projectId' => $projectId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_Job($data);
      } else {
        return $data;
      }
    }
     ...
     * @param CFGS_Google_QueryRequest $postBody
     * @param array $optParams Optional parameters.
     * @return CFGS_Google_QueryResponse
     */
    public function query($projectId, CFGS_Google_QueryRequest $postBody, $optParams = array()) {
      $params = array('projectId' => $projectId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('query', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_QueryResponse($data);
      } else {
        return $data;
      }
    }
    ...
    public function listJobs($projectId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_JobList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CFGS_Google_GetQueryResultsResponse
     */
    public function getQueryResults($projectId, $jobId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_GetQueryResultsResponse($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CFGS_Google_TabledataServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @return CFGS_Google_TableDataList
     */
    public function listTabledata($projectId, $datasetId, $tableId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_TableDataList($data);
      } else {
        return $data;
      }
    }
  ...
  class CFGS_Google_ProjectsServiceResource extends CFGS_Google_ServiceResource {
     ...
     * @opt_param string pageToken Page token, returned by a previous call, to request the next page of results
     * @opt_param string maxResults Maximum number of results to return
     * @return CFGS_Google_ProjectList
     */
    public function listProjects($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CFGS_Google_ProjectList($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for CFGS_Google_Bigquery (v2).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_BigqueryService extends CFGS_Google_Service {
  public $tables;
  public $datasets;
  public $jobs;
  public $tabledata;
...
class CFGS_Google_Dataset extends CFGS_Google_Model {
  public $kind;
  public $description;
  protected $__datasetReferenceType = 'CFGS_Google_DatasetReference';
  protected $__datasetReferenceDataType = '';
  public $datasetReference;
  public $creationTime;
  protected $__accessType = 'CFGS_Google_DatasetAccess';
  ...
  public function setDatasetReference(CFGS_Google_DatasetReference $datasetReference) {
  ...
  public function setAccess(/* array(CFGS_Google_DatasetAccess) */ $access) {
    $this->assertIsArray($access, 'CFGS_Google_DatasetAccess', __METHOD__);
    $this->access = $access;
  }
...
class CFGS_Google_DatasetAccess extends CFGS_Google_Model {
  public $specialGroup;
  public $domain;
  public $role;
  public $groupByEmail;
...
class CFGS_Google_DatasetList extends CFGS_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__datasetsType = 'CFGS_Google_DatasetListDatasets';
  ...
  public function setDatasets(/* array(CFGS_Google_DatasetListDatasets) */ $datasets) {
    $this->assertIsArray($datasets, 'CFGS_Google_DatasetListDatasets', __METHOD__);
...
class CFGS_Google_DatasetListDatasets extends CFGS_Google_Model {
  public $friendlyName;
  public $kind;
  public $id;
  protected $__datasetReferenceType = 'CFGS_Google_DatasetReference';
...
class CFGS_Google_DatasetReference extends CFGS_Google_Model {
  public $projectId;
  public $datasetId;
...
class CFGS_Google_ErrorProto extends CFGS_Google_Model {
  public $debugInfo;
  public $message;
  public $reason;
  public $location;
...
class CFGS_Google_GetQueryResultsResponse extends CFGS_Google_Model {
  public $kind;
  protected $__rowsType = 'CFGS_Google_TableRow';
  protected $__rowsDataType = 'array';
  public $rows;
  protected $__jobReferenceType = 'CFGS_Google_JobReference';
  protected $__jobReferenceDataType = '';
  public $jobReference;
  public $jobComplete;
  public $totalRows;
  public $etag;
  protected $__schemaType = 'CFGS_Google_TableSchema';
  ...
  public function setRows(/* array(CFGS_Google_TableRow) */ $rows) {
    $this->assertIsArray($rows, 'CFGS_Google_TableRow', __METHOD__);
    $this->rows = $rows;
  }
  public function getRows() {
    return $this->rows;
  }
  public function setJobReference(CFGS_Google_JobReference $jobReference) {
  ...
  public function setSchema(CFGS_Google_TableSchema $schema) {
    $this->schema = $schema;
  }
...
class CFGS_Google_Job extends CFGS_Google_Model {
  protected $__statusType = 'CFGS_Google_JobStatus';
  protected $__statusDataType = '';
  public $status;
  public $kind;
  protected $__statisticsType = 'CFGS_Google_JobStatistics';
  ...
  public $jobReference;
  public $etag;
  protected $__configurationType = 'CFGS_Google_JobConfiguration';
  protected $__configurationDataType = '';
  public $configuration;
  public $id;
  public $selfLink;
  public function setStatus(CFGS_Google_JobStatus $status) {
    $this->status = $status;
  }
  ...
  public function setStatistics(CFGS_Google_JobStatistics $statistics) {
  ...
  public function setConfiguration(CFGS_Google_JobConfiguration $configuration) {
...
class CFGS_Google_JobConfiguration extends CFGS_Google_Model {
  protected $__loadType = 'CFGS_Google_JobConfigurationLoad';
  protected $__loadDataType = '';
  public $load;
  protected $__linkType = 'CFGS_Google_JobConfigurationLink';
  protected $__linkDataType = '';
  public $link;
  protected $__queryType = 'CFGS_Google_JobConfigurationQuery';
  protected $__queryDataType = '';
  public $query;
  protected $__copyType = 'CFGS_Google_JobConfigurationTableCopy';
  protected $__copyDataType = '';
  public $copy;
  protected $__extractType = 'CFGS_Google_JobConfigurationExtract';
  protected $__extractDataType = '';
  public $extract;
  public $properties;
  public function setLoad(CFGS_Google_JobConfigurationLoad $load) {
    $this->load = $load;
  }
  public function getLoad() {
    return $this->load;
  }
  public function setLink(CFGS_Google_JobConfigurationLink $link) {
    $this->link = $link;
  }
  public function getLink() {
    return $this->link;
  }
  public function setQuery(CFGS_Google_JobConfigurationQuery $query) {
    $this->query = $query;
  }
  public function getQuery() {
    return $this->query;
  }
  public function setCopy(CFGS_Google_JobConfigurationTableCopy $copy) {
    $this->copy = $copy;
  }
  public function getCopy() {
    return $this->copy;
  }
  public function setExtract(CFGS_Google_JobConfigurationExtract $extract) {
...
class CFGS_Google_JobConfigurationExtract extends CFGS_Google_Model {
  public $destinationUri;
  public $fieldDelimiter;
  protected $__sourceTableType = 'CFGS_Google_TableReference';
  ...
  public function setSourceTable(CFGS_Google_TableReference $sourceTable) {
...
class CFGS_Google_JobConfigurationLink extends CFGS_Google_Model {
  public $createDisposition;
  public $writeDisposition;
  protected $__destinationTableType = 'CFGS_Google_TableReference';
  ...
  public function setDestinationTable(CFGS_Google_TableReference $destinationTable) {
    $this->destinationTable = $destinationTable;
  }
  public function getDestinationTable() {
    return $this->destinationTable;
  }
  public function setSourceUri(/* array(CFGS_Google_string) */ $sourceUri) {
    $this->assertIsArray($sourceUri, 'CFGS_Google_string', __METHOD__);
...
class CFGS_Google_JobConfigurationLoad extends CFGS_Google_Model {
  public $encoding;
  public $fieldDelimiter;
  protected $__destinationTableType = 'CFGS_Google_TableReference';
  protected $__destinationTableDataType = '';
  ...
  public function setSourceUris(/* array(CFGS_Google_string) */ $sourceUris) {
    $this->assertIsArray($sourceUris, 'CFGS_Google_string', __METHOD__);
...
class CFGS_Google_JobConfigurationQuery extends CFGS_Google_Model {
  protected $__defaultDatasetType = 'CFGS_Google_DatasetReference';
  ...
  public $createDisposition;
  public $query;
  public function setDefaultDataset(CFGS_Google_DatasetReference $defaultDataset) {
...
class CFGS_Google_JobConfigurationTableCopy extends CFGS_Google_Model {
  public $createDisposition;
  public $writeDisposition;
  protected $__destinationTableType = 'CFGS_Google_TableReference';
  protected $__destinationTableDataType = '';
...
class CFGS_Google_JobList extends CFGS_Google_Model {
  public $nextPageToken;
  public $totalItems;
  public $kind;
  public $etag;
  protected $__jobsType = 'CFGS_Google_JobListJobs';
  ...
  public function setJobs(/* array(CFGS_Google_JobListJobs) */ $jobs) {
    $this->assertIsArray($jobs, 'CFGS_Google_JobListJobs', __METHOD__);
    $this->jobs = $jobs;
  }
...
class CFGS_Google_JobListJobs extends CFGS_Google_Model {
  protected $__statusType = 'CFGS_Google_JobStatus';
  protected $__statusDataType = '';
  public $status;
  public $kind;
  ...
  public $configuration;
  public $id;
  protected $__errorResultType = 'CFGS_Google_ErrorProto';
  ...
  public function setErrorResult(CFGS_Google_ErrorProto $errorResult) {
...
class CFGS_Google_JobReference extends CFGS_Google_Model {
  public $projectId;
  public $jobId;
  public function setProjectId($projectId) {
    $this->projectId = $projectId;
...
class CFGS_Google_JobStatistics extends CFGS_Google_Model {
  public $endTime;
...
class CFGS_Google_JobStatus extends CFGS_Google_Model {
  public $state;
  protected $__errorsType = 'CFGS_Google_ErrorProto';
  ...
  public function setErrors(/* array(CFGS_Google_ErrorProto) */ $errors) {
    $this->assertIsArray($errors, 'CFGS_Google_ErrorProto', __METHOD__);
    $this->errors = $errors;
  }
...
class CFGS_Google_ProjectList extends CFGS_Google_Model {
  public $nextPageToken;
  public $totalItems;
  public $kind;
  public $etag;
  protected $__projectsType = 'CFGS_Google_ProjectListProjects';
  ...
  public function setProjects(/* array(CFGS_Google_ProjectListProjects) */ $projects) {
    $this->assertIsArray($projects, 'CFGS_Google_ProjectListProjects', __METHOD__);
...
class CFGS_Google_ProjectListProjects extends CFGS_Google_Model {
  public $friendlyName;
  public $kind;
  public $id;
  protected $__projectReferenceType = 'CFGS_Google_ProjectReference';
  ...
  public function setProjectReference(CFGS_Google_ProjectReference $projectReference) {
...
class CFGS_Google_ProjectReference extends CFGS_Google_Model {
  public $projectId;
  public function setProjectId($projectId) {
    $this->projectId = $projectId;
  }
...
class CFGS_Google_QueryRequest extends CFGS_Google_Model {
  public $timeoutMs;
  public $kind;
  public $dryRun;
  protected $__defaultDatasetType = 'CFGS_Google_DatasetReference';
...
class CFGS_Google_QueryResponse extends CFGS_Google_Model {
  public $kind;
  protected $__rowsType = 'CFGS_Google_TableRow';
  protected $__rowsDataType = 'array';
  public $rows;
...
class CFGS_Google_Table extends CFGS_Google_Model {
  public $kind;
  public $lastModifiedTime;
  public $description;
  public $creationTime;
  protected $__tableReferenceType = 'CFGS_Google_TableReference';
  ...
  public function setTableReference(CFGS_Google_TableReference $tableReference) {
...
class CFGS_Google_TableDataList extends CFGS_Google_Model {
  public $pageToken;
  public $kind;
  public $etag;
  protected $__rowsType = 'CFGS_Google_TableRow';
...
class CFGS_Google_TableFieldSchema extends CFGS_Google_Model {
  protected $__fieldsType = 'CFGS_Google_TableFieldSchema';
  protected $__fieldsDataType = 'array';
  public $fields;
  public $type;
  public $mode;
  public $name;
  public function setFields(/* array(CFGS_Google_TableFieldSchema) */ $fields) {
    $this->assertIsArray($fields, 'CFGS_Google_TableFieldSchema', __METHOD__);
    $this->fields = $fields;
  }
...
class CFGS_Google_TableList extends CFGS_Google_Model {
  public $nextPageToken;
  protected $__tablesType = 'CFGS_Google_TableListTables';
  ...
  public function setTables(/* array(CFGS_Google_TableListTables) */ $tables) {
    $this->assertIsArray($tables, 'CFGS_Google_TableListTables', __METHOD__);
    $this->tables = $tables;
  }
...
class CFGS_Google_TableListTables extends CFGS_Google_Model {
  public $friendlyName;
  public $kind;
  public $id;
  protected $__tableReferenceType = 'CFGS_Google_TableReference';
...
class CFGS_Google_TableReference extends CFGS_Google_Model {
  public $projectId;
  public $tableId;
  public $datasetId;
  public function setProjectId($projectId) {
...
class CFGS_Google_TableRow extends CFGS_Google_Model {
  protected $__fType = 'CFGS_Google_TableRowF';
  protected $__fDataType = 'array';
  public $f;
  public function setF(/* array(CFGS_Google_TableRowF) */ $f) {
    $this->assertIsArray($f, 'CFGS_Google_TableRowF', __METHOD__);
    $this->f = $f;
  }
...
class CFGS_Google_TableRowF extends CFGS_Google_Model {
  public $v;
...
class CFGS_Google_TableSchema extends CFGS_Google_Model {
  protected $__fieldsType = 'CFGS_Google_TableFieldSchema';
  protected $__fieldsDataType = 'array';
  public $fields;
  public function setFields(/* array(CFGS_Google_TableFieldSchema) */ $fields) {
