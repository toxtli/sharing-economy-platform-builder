 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $shoppingService = new CFGS_Google_ShoppingService(...);
   *   $products = $shoppingService->products;
   *  </code>
   */
  class CFGS_Google_ProductsServiceResource extends CFGS_Google_ServiceResource {
    ...
    public function listProducts($source, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_Products($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($source, $accountId, $productIdType, $productId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CFGS_Google_Product($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for CFGS_Google_Shopping (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CFGS_Google_ShoppingService extends CFGS_Google_Service {
  public $products;
  /**
...
class CFGS_Google_Product extends CFGS_Google_Model {
  ...
  public function setProduct(CFGS_Google_ShoppingModelProductJsonV1 $product) {
  ...
  public function setRecommendations(/* array(CFGS_Google_ShoppingModelRecommendationsJsonV1) */ $recommendations) {
    $this->assertIsArray($recommendations, 'CFGS_Google_ShoppingModelRecommendationsJsonV1', __METHOD__);
    $this->recommendations = $recommendations;
  }
  public function getRecommendations() {
    return $this->recommendations;
  }
  public function setDebug(CFGS_Google_ShoppingModelDebugJsonV1 $debug) {
    $this->debug = $debug;
  }
  ...
  public function setCategories(/* array(CFGS_Google_ShoppingModelCategoryJsonV1) */ $categories) {
    $this->assertIsArray($categories, 'CFGS_Google_ShoppingModelCategoryJsonV1', __METHOD__);
...
class CFGS_Google_Products extends CFGS_Google_Model {
  protected $__promotionsType = 'CFGS_Google_ProductsPromotions';
  protected $__promotionsDataType = 'array';
  public $promotions;
  public $selfLink;
  public $kind;
  protected $__storesType = 'CFGS_Google_ProductsStores';
  protected $__storesDataType = 'array';
  public $stores;
  public $currentItemCount;
  protected $__itemsType = 'CFGS_Google_Product';
  protected $__itemsDataType = 'array';
  public $items;
  protected $__facetsType = 'CFGS_Google_ProductsFacets';
  ...
  public $etag;
  public $requestId;
  protected $__categoryRecommendationsType = 'CFGS_Google_ShoppingModelRecommendationsJsonV1';
  protected $__categoryRecommendationsDataType = 'array';
  public $categoryRecommendations;
  protected $__debugType = 'CFGS_Google_ShoppingModelDebugJsonV1';
  protected $__debugDataType = '';
  public $debug;
  protected $__spellingType = 'CFGS_Google_ProductsSpelling';
  ...
  protected $__categoriesDataType = 'array';
  public $categories;
  public function setPromotions(/* array(CFGS_Google_ProductsPromotions) */ $promotions) {
    $this->assertIsArray($promotions, 'CFGS_Google_ProductsPromotions', __METHOD__);
  ...
  public function setStores(/* array(CFGS_Google_ProductsStores) */ $stores) {
    $this->assertIsArray($stores, 'CFGS_Google_ProductsStores', __METHOD__);
    $this->stores = $stores;
  }
  ...
  public function setItems(/* array(CFGS_Google_Product) */ $items) {
    $this->assertIsArray($items, 'CFGS_Google_Product', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
  }
  public function setFacets(/* array(CFGS_Google_ProductsFacets) */ $facets) {
    $this->assertIsArray($facets, 'CFGS_Google_ProductsFacets', __METHOD__);
    $this->facets = $facets;
  }
  ...
  public function setRedirects(/* array(CFGS_Google_string) */ $redirects) {
    $this->assertIsArray($redirects, 'CFGS_Google_string', __METHOD__);
  ...
  public function setRelatedQueries(/* array(CFGS_Google_string) */ $relatedQueries) {
    $this->assertIsArray($relatedQueries, 'CFGS_Google_string', __METHOD__);
  ...
  public function setCategoryRecommendations(/* array(CFGS_Google_ShoppingModelRecommendationsJsonV1) */ $categoryRecommendations) {
    $this->assertIsArray($categoryRecommendations, 'CFGS_Google_ShoppingModelRecommendationsJsonV1', __METHOD__);
  ...
  public function setSpelling(CFGS_Google_ProductsSpelling $spelling) {
...
class CFGS_Google_ProductsFacets extends CFGS_Google_Model {
  public $count;
  public $displayName;
  public $name;
  protected $__bucketsType = 'CFGS_Google_ProductsFacetsBuckets';
  ...
  public function setBuckets(/* array(CFGS_Google_ProductsFacetsBuckets) */ $buckets) {
    $this->assertIsArray($buckets, 'CFGS_Google_ProductsFacetsBuckets', __METHOD__);
...
class CFGS_Google_ProductsFacetsBuckets extends CFGS_Google_Model {
  public $count;
  public $minExclusive;
  public $min;
  public $max;
...
class CFGS_Google_ProductsPromotions extends CFGS_Google_Model {
  protected $__productType = 'CFGS_Google_ShoppingModelProductJsonV1';
  protected $__productDataType = '';
  public $product;
  public $description;
  ...
  public $destLink;
  public $customHtml;
  protected $__customFieldsType = 'CFGS_Google_ProductsPromotionsCustomFields';
  ...
  public function setCustomFields(/* array(CFGS_Google_ProductsPromotionsCustomFields) */ $customFields) {
    $this->assertIsArray($customFields, 'CFGS_Google_ProductsPromotionsCustomFields', __METHOD__);
...
class CFGS_Google_ProductsPromotionsCustomFields extends CFGS_Google_Model {
  public $name;
  public $value;
  public function setName($name) {
    $this->name = $name;
...
class CFGS_Google_ProductsSpelling extends CFGS_Google_Model {
  public $suggestion;
...
class CFGS_Google_ProductsStores extends CFGS_Google_Model {
  public $storeCode;
  public $name;
  public $storeName;
  public $storeId;
...
class CFGS_Google_ShoppingModelCategoryJsonV1 extends CFGS_Google_Model {
  public $url;
  public $shortName;
  public $parents;
  public $id;
  ...
  public function setParents(/* array(CFGS_Google_string) */ $parents) {
    $this->assertIsArray($parents, 'CFGS_Google_string', __METHOD__);
...
class CFGS_Google_ShoppingModelDebugJsonV1 extends CFGS_Google_Model {
  ...
  protected $__backendTimesType = 'CFGS_Google_ShoppingModelDebugJsonV1BackendTimes';
  ...
  public function setBackendTimes(/* array(CFGS_Google_ShoppingModelDebugJsonV1BackendTimes) */ $backendTimes) {
    $this->assertIsArray($backendTimes, 'CFGS_Google_ShoppingModelDebugJsonV1BackendTimes', __METHOD__);
...
class CFGS_Google_ShoppingModelDebugJsonV1BackendTimes extends CFGS_Google_Model {
  public $serverMillis;
  public $hostName;
  public $name;
  public $elapsedMillis;
...
class CFGS_Google_ShoppingModelProductJsonV1 extends CFGS_Google_Model {
  public $queryMatched;
  public $gtin;
  protected $__imagesType = 'CFGS_Google_ShoppingModelProductJsonV1Images';
  protected $__imagesDataType = 'array';
  public $images;
  protected $__inventoriesType = 'CFGS_Google_ShoppingModelProductJsonV1Inventories';
  protected $__inventoriesDataType = 'array';
  public $inventories;
  protected $__authorType = 'CFGS_Google_ShoppingModelProductJsonV1Author';
  ...
  public $brand;
  public $internal3;
  protected $__internal4Type = 'CFGS_Google_ShoppingModelProductJsonV1Internal4';
  ...
  public $link;
  public $mpns;
  protected $__attributesType = 'CFGS_Google_ShoppingModelProductJsonV1Attributes';
  protected $__attributesDataType = 'array';
  public $attributes;
  public $totalMatchingVariants;
  protected $__variantsType = 'CFGS_Google_ShoppingModelProductJsonV1Variants';
  ...
  public function setImages(/* array(CFGS_Google_ShoppingModelProductJsonV1Images) */ $images) {
    $this->assertIsArray($images, 'CFGS_Google_ShoppingModelProductJsonV1Images', __METHOD__);
    $this->images = $images;
  }
  public function getImages() {
    return $this->images;
  }
  public function setInventories(/* array(CFGS_Google_ShoppingModelProductJsonV1Inventories) */ $inventories) {
    $this->assertIsArray($inventories, 'CFGS_Google_ShoppingModelProductJsonV1Inventories', __METHOD__);
    $this->inventories = $inventories;
  }
  public function getInventories() {
    return $this->inventories;
  }
  public function setAuthor(CFGS_Google_ShoppingModelProductJsonV1Author $author) {
    $this->author = $author;
  }
  ...
  public function setInternal8(/* array(CFGS_Google_string) */ $internal8) {
    $this->assertIsArray($internal8, 'CFGS_Google_string', __METHOD__);
  ...
  public function setGtins(/* array(CFGS_Google_string) */ $gtins) {
    $this->assertIsArray($gtins, 'CFGS_Google_string', __METHOD__);
    $this->gtins = $gtins;
  }
  public function getGtins() {
    return $this->gtins;
  }
  public function setInternal1(/* array(CFGS_Google_string) */ $internal1) {
    $this->assertIsArray($internal1, 'CFGS_Google_string', __METHOD__);
  ...
  public function setInternal4(/* array(CFGS_Google_ShoppingModelProductJsonV1Internal4) */ $internal4) {
    $this->assertIsArray($internal4, 'CFGS_Google_ShoppingModelProductJsonV1Internal4', __METHOD__);
  ...
  public function setMpns(/* array(CFGS_Google_string) */ $mpns) {
    $this->assertIsArray($mpns, 'CFGS_Google_string', __METHOD__);
    $this->mpns = $mpns;
  }
  public function getMpns() {
    return $this->mpns;
  }
  public function setAttributes(/* array(CFGS_Google_ShoppingModelProductJsonV1Attributes) */ $attributes) {
    $this->assertIsArray($attributes, 'CFGS_Google_ShoppingModelProductJsonV1Attributes', __METHOD__);
  ...
  public function setVariants(/* array(CFGS_Google_ShoppingModelProductJsonV1Variants) */ $variants) {
    $this->assertIsArray($variants, 'CFGS_Google_ShoppingModelProductJsonV1Variants', __METHOD__);
  ...
  public function setInternal10(/* array(CFGS_Google_string) */ $internal10) {
    $this->assertIsArray($internal10, 'CFGS_Google_string', __METHOD__);
...
class CFGS_Google_ShoppingModelProductJsonV1Attributes extends CFGS_Google_Model {
  public $type;
  public $value;
  public $displayName;
  public $name;
...
class CFGS_Google_ShoppingModelProductJsonV1Author extends CFGS_Google_Model {
  public $name;
  public $accountId;
  public function setName($name) {
    $this->name = $name;
...
class CFGS_Google_ShoppingModelProductJsonV1Images extends CFGS_Google_Model {
  public $status;
  public $link;
  protected $__thumbnailsType = 'CFGS_Google_ShoppingModelProductJsonV1ImagesThumbnails';
  ...
  public function setThumbnails(/* array(CFGS_Google_ShoppingModelProductJsonV1ImagesThumbnails) */ $thumbnails) {
    $this->assertIsArray($thumbnails, 'CFGS_Google_ShoppingModelProductJsonV1ImagesThumbnails', __METHOD__);
...
class CFGS_Google_ShoppingModelProductJsonV1ImagesThumbnails extends CFGS_Google_Model {
  public $content;
  public $width;
  public $link;
  public $height;
...
class CFGS_Google_ShoppingModelProductJsonV1Internal4 extends CFGS_Google_Model {
  public $node;
  public $confidence;
...
class CFGS_Google_ShoppingModelProductJsonV1Inventories extends CFGS_Google_Model {
...
class CFGS_Google_ShoppingModelProductJsonV1Variants extends CFGS_Google_Model {
  protected $__variantType = 'CFGS_Google_ShoppingModelProductJsonV1';
  protected $__variantDataType = '';
  public $variant;
  public function setVariant(CFGS_Google_ShoppingModelProductJsonV1 $variant) {
...
class CFGS_Google_ShoppingModelRecommendationsJsonV1 extends CFGS_Google_Model {
  protected $__recommendationListType = 'CFGS_Google_ShoppingModelRecommendationsJsonV1RecommendationList';
  protected $__recommendationListDataType = 'array';
  public $recommendationList;
  public $type;
  public function setRecommendationList(/* array(CFGS_Google_ShoppingModelRecommendationsJsonV1RecommendationList) */ $recommendationList) {
    $this->assertIsArray($recommendationList, 'CFGS_Google_ShoppingModelRecommendationsJsonV1RecommendationList', __METHOD__);
...
class CFGS_Google_ShoppingModelRecommendationsJsonV1RecommendationList extends CFGS_Google_Model {
  protected $__productType = 'CFGS_Google_ShoppingModelProductJsonV1';
  protected $__productDataType = '';
  public $product;
  public function setProduct(CFGS_Google_ShoppingModelProductJsonV1 $product) {
