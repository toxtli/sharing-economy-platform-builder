 ...
 */
class CFGS_Google_Client {
  /**
   * @static
   * @var CFGS_Google_Auth $auth
   */
  static $auth;

  /**
   * @static
   * @var CFGS_Google_IO $io
   */
  static $io;

  /**
   * @static
   * @var CFGS_Google_Cache $cache
   */
  static $cache;
  ...
  public function addService($service, $version = false) {
    ...
    if ($this->authenticated) {
      throw new CFGS_Google_Exceptions('Cant add services after having authenticated');
    }
   ...
   * or CFGS_Google_Client#getAccessToken().
   ...
   * @return CFGS_Google_LoginTicket Returns an apiLoginTicket if the verification was
   * successful.
   */
  ...
  /**
   * @param CFGS_Google_AssertionCredentials $creds
   * @return void
   */
  ...
  /**
   * @static
   * @return CFGS_Google_Auth the implementation of apiAuth.
   */
  public static function getAuth() {
    return CFGS_Google_Client::$auth;
  }

  /**
   * @static
   * @return CFGS_Google_IO the implementation of apiIo.
   */
  public static function getIo() {
    return CFGS_Google_Client::$io;
  }

  /**
   * @return CFGS_Google_Cache the implementation of apiCache.
   */
  public function getCache() {
    return CFGS_Google_Client::$cache;
  }
}

// Exceptions that the Google PHP API Library can throw
class CFGS_Google_Exceptions extends Exception {}
class CFGS_Google_AuthException extends CFGS_Google_Exceptions {}
class CFGS_Google_CacheException extends CFGS_Google_Exceptions {}
class CFGS_Google_IOException extends CFGS_Google_Exceptions {}
class CFGS_Google_ServiceException extends CFGS_Google_Exceptions {
  /**
