...
class Paratext {
	...
	public function control_button() {
		...
		<li class="list-group-item" data-type="<?php echo __CLASS__ ?>" for="Paratext">
			<span class="lfi lfi-name"><i class="fa fa-align-justify"></i></span> Paragraph
			<a title="Paratext" rel="Paratext" class="add pull-right add-form-field" data-template='Paratext' href="#"><i class="fa fa-plus-circle ttipf" title=""></i></a>
	</li>
	    <?php
