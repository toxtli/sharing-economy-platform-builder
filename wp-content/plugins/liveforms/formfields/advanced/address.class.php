...
class Address {
	...
	public function control_button() {
		...
		<li class="list-group-item" data-type="<?php echo __CLASS__ ?>" for="Address">
			<span class="lfi lfi-name"><i class="fa fa-map-o"></i></span> Address
			<a title="Address" rel="Address" class="add pull-right add-form-field" data-template='Address' href="#"><i class="fa fa-plus-circle ttipf" title=""></i></a>
	</li>
	    <?php
...
?>
		<li class="list-group-item" data-type="<?php echo __CLASS__ ?>" id="field_<?php echo $fieldindex; ?>">
			...
			<div class="field-preview address">
				<?php 	
