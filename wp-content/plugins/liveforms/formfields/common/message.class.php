...
class Message {
	...
	public function control_button() {
		ob_start();
		?>
		<li class="list-group-item" data-type="<?php echo __CLASS__ ?>" for="Message">
			<span class="lfi lfi-name"><i class="fa fa-align-left"></i></span> Message
			<a title="Message" rel="Message" class="add pull-right add-form-field" data-template='Message' href="#"><i class="fa fa-plus-circle ttipf" title=""></i></a>
		</li>
	    <?php
