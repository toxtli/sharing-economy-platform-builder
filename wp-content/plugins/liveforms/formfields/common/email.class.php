...
class Email {
	...
	public function control_button() {
		ob_start();
		?>
		<li class="list-group-item" data-type="<?php echo __CLASS__ ?>" for="Email">
			<span class="lfi lfi-name"><i class="fa fa-envelope-o"></i></span> Email
			<a title="Email" rel="Email" class="add pull-right add-form-field" data-template='Email' href="#"><i class="fa fa-plus-circle ttipf" title=""></i></a>
		</li>
	    <?php
