...
class SimpleCaptcha {
    ...
    public $session_var = 'liveform_captcha';
    ...
    public function __construct($config = array()) {
        $this->resourcesPath = LF_BASE_DIR . 'libs/phpcaptcha/' . $this->resourcesPath;
    }
    ...
    public function get_image() {
        ...
        ob_start();
        $this->CreateImage();
        $image_file = ob_get_clean();
        $captcha_data = array('text' => hash('sha256',$_SESSION['liveform_captcha']), 'image' => base64_encode($image_file));
        return $captcha_data;
    }
}
